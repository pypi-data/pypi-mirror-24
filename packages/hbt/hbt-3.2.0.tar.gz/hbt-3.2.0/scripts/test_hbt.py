...
from hbt import get_review_url, update_commit_message, exist_remote_branch, is_push_failed
...
'Note about fast-forwards' section of 'git push --help' for details.
    """
    self.assertTrue(is_push_failed(rejected))
...
'Note about fast-forwards' section of 'git push --help' for details.
    """
    self.assertTrue(is_push_failed(error))

    success = """
开始检查review request是否能够提交： 5526
对象计数中: 7, 完成.
Delta compression using up to 4 threads.
压缩对象中: 100% (7/7), 完成.
写入对象中: 100% (7/7), 1.31 KiB | 0 bytes/s, 完成.
Total 7 (delta 5), reused 0 (delta 0)
To git.56qq.com:Android-Team/BuildScript.git
   571216a..816baea  HEAD -> master
    """
    self.assertFalse(is_push_failed(success))
