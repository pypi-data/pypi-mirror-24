...
- `#506 <https://github.com/tox-dev/tox/issues/506>`_: With `-a`: do not show additional environments header if there are none
...
- `#515 <https://github.com/tox-dev/tox/issues/515>`_: Don't require environment variables in test environments
