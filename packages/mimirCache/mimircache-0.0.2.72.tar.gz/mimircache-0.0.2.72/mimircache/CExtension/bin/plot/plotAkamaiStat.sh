function plot_akamaiStat(){ 
	...
	akamaiStatDat=$1
	n_lines=$(wc -l $akamaiStatDat|awk '{print $1}')
	echo "$(pwd) n_lines $n_lines"
	...
	echo '
		...
		plot "'$akamaiStatDat'" using ($0*100/'$n_lines'):1 w line 
		...
		# # set the color and font (and a default text) for the title and each axis
		# set title "Traffic To Origin" textcolor rgb text_color font my_font
		# set xlabel "Time" textcolor rgb text_color font my_font
		# set ylabel "Traffic To Origin" textcolor rgb text_color font my_font

		# # set terminal postscript portrait enhanced color dashed lw 1 "DejaVuSans" 12
		# # set output "temp.ps"
		# set terminal png size 800,600 enhanced font my_font # "Helvetica,20"
		# set output "traffic_to_origin.png"

		# set format x "%.0f%%" 

		# unset key 

		# plot "'$akamaiStatDat'" using ($0*100/'$n_lines'):4 w line 
		...
		# # set the color and font (and a default text) for the title and each axis
		# set title "Traffic Between Layers" textcolor rgb text_color font my_font
		# set xlabel "Time" textcolor rgb text_color font my_font
		# set ylabel "Traffic Between Layers" textcolor rgb text_color font my_font

		# # set terminal postscript portrait enhanced color dashed lw 1 "DejaVuSans" 12
		# # set output "temp.ps"
		# set terminal png size 800,600 enhanced font my_font # "Helvetica,20"
		# set output "traffic_between_layers.png"

		# set format x "%.0f%%" 

		# unset key 

		# plot "'$akamaiStatDat'" using ($0*100/'$n_lines'):5 w line 
