serverDat=$1
serverID=$(echo ${serverDat/.dat/})
baseTime=$(cat $serverDat|head -n 2|tail -n 1|cut -d ' ' -f 1)
...
echo '
	...
	set title "' $serverID 'Hit Ratio" font ",20"
	set key 
	set samples 50
	set style data points


	plot "'$serverDat'" using (($1-'$baseTime')/3600/24):4 title columnheader(4) w line, \
	"" u (($1-'$baseTime')/3600/24):7 t columnheader(7) w line, \
	"" u (($1-'$baseTime')/3600/24):10 t columnheader(10) w line, \
	"" u (($1-'$baseTime')/3600/24):13 t columnheader(13) w line
