...
class ClassRestapiTest(ApiAuthAdminTestCase):
    def set_up(self):
        super().set_up()
        self.gen = ModelsGen()
    ...
    def test_create_trans_str_with_name_in_default_lang(self):
    ...
    def test_create_trans_str_with_name_in_random_lang(self):
        response = self.client.post(reverse('class-list'), format='json', data=dict(
            code='test_code',
            type=Type.INT,
            name=TransStr(fi=''),
    ...
    def test_create_trans_str_with_name_empty(self):
        response = self.client.post(reverse('class-list'), format='json', data=dict(
            code='test_code',
            type=Type.INT,
            name={},
