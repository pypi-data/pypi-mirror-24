...
const type_enum_decorator_1 = require("app/type.enum.decorator");
...
const loading_bar_serivce_1 = require("app/services/decorators/loading-bar.serivce");
const notify_serivce_1 = require("app/services/decorators/notify.serivce");
...
__decorate([
    loading_bar_serivce_1.asyncShowLoadingBar,
    notify_serivce_1.asyncNotifyOn({ success: 'The saving complete', error: 'The saving failed' }),
...
__decorate([
    loading_bar_serivce_1.asyncShowLoadingBar,
    notify_serivce_1.asyncNotifyOn({ success: null, error: 'Creation failed' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
...
__decorate([
    notify_serivce_1.asyncNotifyOn({ success: null, error: 'Network error during product types retrieving' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
