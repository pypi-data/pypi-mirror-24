...
describe('options test', () => {
    ...
    it('edits the option value', (done) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield optionValueInputFi.sendKeys(optionValueInputFiNew);
        yield protractor_2.$('#cls-save-button').click();
        yield protractor_1.browser.waitForAngular();
        yield navigation_1.loadClsEditForm();
        yield protractor_2.$$(optionValueButtonFiSelector).first().click();
        let optionValueInputEnValue = yield protractor_2.$(optionValueInputFiSelector).getAttribute('value');
