...
# DO NOT CHANGE
SNIPS_BLE_SERVICE_UUID = "00000000-9D9E-42D1-A78B-638ED22CC768"
SNIPS_BLE_CHARACTERISTIC_UUID = "00000000-7A2D-4A98-A2E2-41688E3D8283"
...
class Bluetooth:
    ...
    def install_mqtt_relay():
        ...
        execute_command("npm install --prefix=./.snips snips-mqtt-relay")
    ...
    def get_params():
        ...
        snipsble_path = "{}/.snips/node_modules/snips-mqtt-relay".format(os.getcwd())
