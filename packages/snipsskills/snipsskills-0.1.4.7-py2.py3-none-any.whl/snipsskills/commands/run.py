...
class Run(Base):
    ...
    def run(self):
        ...
        print("Starting Snips SDK.")
        p1 = subprocess.Popen("docker stop snips".split(), stdout=FNULL)
        output, error = p1.communicate()
        p1 = subprocess.Popen("snips".split(), stdout=FNULL)
        output, error = p1.communicate()

        print("Starting Snips Skills server.")
