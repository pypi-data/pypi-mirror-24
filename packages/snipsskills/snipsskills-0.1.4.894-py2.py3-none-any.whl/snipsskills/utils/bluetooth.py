...
SNIPS_BLE_SERVICE_UUID = "snipsble"
SNIPS_BLE_CHARACTERISTIC_UUID = "snipsble"
...
class Bluetooth:
    ...
    def install_mqtt_relay():
        ...
        execute_command("npm install snips-mqtt-relay")
    ...
    def get_params():
        ...
        snipsble_path = "{}/node_modules/snips-mqtt-relay".format(os.getcwd())
