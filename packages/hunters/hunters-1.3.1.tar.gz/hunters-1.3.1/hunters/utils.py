...
class ForeverThreadPool(object):
    ...
    def _submit(self, target, args):
        ...
        while True:
            ...
            for t in pending:
                logger.info("START THREAD[%s]" % threading.currentThread().name)
                t.start()
...
if "__main__" == __name__:
    ...
    print(url)
    url = "http://www.so.com/s?ie=utf-8&amp;q=%E5%8C%97%E4%BA%AC%E5%A4%A9%E6%B0%94%E9%A2%84%E6%8A%A5&amp;src=hao_weather"
