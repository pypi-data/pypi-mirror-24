...
from ..share.shine_pb2 import RspToUsers, CloseUsers
...
class Trigger(object):
    ...
    def write_to_client(self, req_task, data):
        ...
        task.conn_id_num = req_task.conn_id_num
        task.node_id_num = req_task.node_id_num
    ...
    def _send_task(self, task):
        ...
        return self.forwarder_input_client.send(task.pack())
