...
class OperationalizationCluster(Resource):
    ...
    _attribute_map = {
        ...
        'modified_on': {'key': 'properties.modifiedOn', 'type': 'str'},
        ...
        'app_insights': {'key': 'properties.appInsights', 'type': 'AppInsightsCredentials'},
        'global_service_configuration': {'key': 'properties.globalServiceConfiguration', 'type': 'GlobalServiceConfiguration'},
    }

    def __init__(self, location, cluster_type, container_service, tags=None, description=None, storage_account=None, container_registry=None, app_insights=None, global_service_configuration=None):
