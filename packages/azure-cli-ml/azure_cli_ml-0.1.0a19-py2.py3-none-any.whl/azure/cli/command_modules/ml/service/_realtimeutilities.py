...
realtime_show_service_header_to_fn_dict = OrderedDict([('Name', TraversalFunction(('Name',))),
                                                       ('Service_Id', TraversalFunction(('Id',))),
                                                       ('Image_Id', TraversalFunction(('Image', 'Id',)))])

realtime_show_service_details_header_to_fn_dict = OrderedDict([('Created_At', TraversalFunction(('CreatedAt',))),
