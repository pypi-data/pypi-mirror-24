...
register_cli_argument('ml service create realtime', 'target_runtime', options_list=('-r',), required=False, default='spark-py', help='Runtime of the web service. Valid runtimes are {}'.format('|'.join(SUPPORTED_RUNTIMES)), arg_group='Unregistered Image')
...
register_cli_argument('ml service create realtime', 'requirements', options_list=('-p',), metavar='requirements.txt', default='', help='A pip requirements.txt file of package needed by the code file.', required=False, arg_group='Unregistered Image')
...
register_cli_argument('ml service update realtime', 'target_runtime', options_list=('-r',), required=False, default='spark-py', help='Runtime of the web service. Valid runtimes are {}'.format('|'.join(SUPPORTED_RUNTIMES)), arg_group='Unregistered Image')
...
register_cli_argument('ml manifest create', 'runtime', options_list=('-r',), default='spark-py', help='Runtime of the web service. Valid runtimes are {}'.format('|'.join(SUPPORTED_RUNTIMES)), required=False)
...
register_cli_argument('ml image create', 'runtime', options_list=('-r',), default='spark-py', help='Runtime of the web service. Valid runtimes are {}'.format('|'.join(SUPPORTED_RUNTIMES)), required=False, arg_group='Unregistered Manifest')
