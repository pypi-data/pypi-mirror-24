...
register_cli_argument('ml service create realtime', 'target_runtime', options_list=('-r',), required=False, default='spark-py', help='Runtime of the web service. Valid runtimes are {}'.format('|'.join(Constants.supported_runtimes)), arg_group='Unregistered Image')
...
register_cli_argument('ml service update realtime', 'target_runtime', options_list=('-r',), required=False, default='spark-py', help='Runtime of the web service. Valid runtimes are {}'.format('|'.join(Constants.supported_runtimes)), arg_group='Unregistered Image')
