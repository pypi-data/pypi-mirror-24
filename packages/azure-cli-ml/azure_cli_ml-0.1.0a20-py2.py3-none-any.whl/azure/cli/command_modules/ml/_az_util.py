...
def az_check_subscription():
    ...
    if answer == 'n' or answer == 'no':
        ...
        new_subscription = input('Enter subscription name: ').rstrip()
...
def az_create_resource_group(context, root_name, append='rg'):
...
def az_create_app_insights_account(root_name, resource_group, no_wait=True):
    """
    ...
    :param no_wait: bool runs asynchonously if True
    """
    ...
    result = client.create_or_update(resource_group, deployment_name, properties, raw=no_wait)
    if no_wait:
