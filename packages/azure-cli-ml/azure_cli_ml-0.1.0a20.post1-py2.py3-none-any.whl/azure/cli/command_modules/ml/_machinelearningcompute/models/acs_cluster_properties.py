...
class AcsClusterProperties(Model):
    ...
    :param orchestrator_type: Type of orchestrator. It cannot be changed once
     the cluster is created. Possible values include: 'Kubernetes', 'Another'
    ...
    def __init__(self, orchestrator_type, orchestrator_properties, system_services=None, agent_count=2, agent_vm_size="Standard_D2_v2"):
