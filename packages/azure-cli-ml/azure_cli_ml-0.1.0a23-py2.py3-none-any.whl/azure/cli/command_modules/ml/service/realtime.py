...
def realtime_service_create(driver_file, dependencies, requirements, schema_file, service_name, target_runtime,
                            app_insights_logging_enabled, model_data_collection_enabled, model_file, num_replicas,
                            image_id, image_type, conda_file, autoscale_enabled, autoscale_min_replicas,
...
def _realtime_service_create(driver_file, dependencies, requirements, schema_file, service_name, target_runtime,
    ...
    if not image_id:
        image_create_success, image_id = _image_create(service_name[:30], image_type, '', None, driver_file,
                                                       schema_file, dependencies, target_runtime, requirements,
                                                       conda_file, model_file, verb, context)
