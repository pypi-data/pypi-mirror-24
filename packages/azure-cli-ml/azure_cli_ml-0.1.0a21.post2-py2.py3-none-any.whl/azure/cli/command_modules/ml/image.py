...
def image_create(image_name, image_type, image_description, manifest_id, driver_file, schema_file, dependencies,
                 runtime, requirements, conda_file, model_file, verb, context=cli_context):
    _image_create(image_name, image_type, image_description, manifest_id, driver_file, schema_file, dependencies,
                  runtime, requirements, conda_file, model_file, verb, context)


def _image_create(image_name, image_type, image_description, manifest_id, driver_file, schema_file, dependencies,
                  runtime, requirements, conda_file, model_file, verb, context):
    ...
    if manifest_id:
        ...
        json_payload['manifestId'] = _manifest_create(image_name, driver_file, None, schema_file, dependencies, runtime,
                                                      requirements, conda_file, None, model_file, verb, context)[1]
    ...
    print('More information: \'az ml image show -i {}\''.format(image_id))
