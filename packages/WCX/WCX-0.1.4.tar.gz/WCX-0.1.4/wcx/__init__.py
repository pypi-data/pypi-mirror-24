...
class Wcx(object):
    ...
    def __init__(self, api_key, secret_key, version = 1):
        ...
        self.base_url = 'http://localhost/wcx_bitbucket/api/v'+str(version)+'/API_CALL'
    ...
    def api_call(self, method, **kwargs):
        ...
        # http parameters
        payload = {}
        headers = {"X-WCX-APIKEY":self.api_key,"X-WCX-PAYLOAD":payload}
        ...
        headers["X-WCX-PAYLOAD"] = base64.b64encode(json.dumps(payload))
