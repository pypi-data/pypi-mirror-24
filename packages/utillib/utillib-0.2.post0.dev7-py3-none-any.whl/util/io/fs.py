...
def remove_recursively(directory, force=False, not_exist_okay=False, exclude_dir=False):
    try:
        ...
        walk_all_in_dir(directory, lambda file: remove_file(file, force=force, not_exist_okay=not_exist_okay), lambda dir: remove_dir(directory, force=force, not_exist_okay=not_exist_okay), exclude_dir=exclude_dir, topdown=False)
