...
EOF
	...
	case "$lsb_dist" in
		amazon)
			...
			curl -sL https://s3.amazonaws.com/spotinst-labs/spotinst-agent/linux-initd/spotinst-agent -o /etc/init.d/spotinst-agent
		...
		ubuntu14)
			...
			log_info "Downloading init.d service file"
			curl -sL https://s3.amazonaws.com/spotinst-labs/spotinst-agent/ubuntu-initd/spotinst-agent -o /etc/init.d/spotinst-agent
			chmod +x /etc/init.d/spotinst-agent
			return
			;;
		...
		suse)
			...
			curl -sL https://s3.amazonaws.com/spotinst-labs/spotinst-agent/spotinst-agent.service -o /etc/systemd/system/spotinst-agent.service
			log_info "done.."
			return
			;;
		...
		ubuntu|debian)
			...
			log_info "Downloading systemd service file"
			curl -sL https://s3.amazonaws.com/spotinst-labs/spotinst-agent/spotinst-agent.service -o /lib/systemd/system/spotinst-agent.service
		...
		fedora|centos|redhat)
			...
			log_info "Downloading systemd service file"
			curl -sL http://s3.amazonaws.com/spotinst-labs/spotinst-agent/spotinst-agent.service -o /lib/systemd/system/spotinst-agent.service
...
log_info "Successfully installed; DONE"#!/bin/sh
set -e
