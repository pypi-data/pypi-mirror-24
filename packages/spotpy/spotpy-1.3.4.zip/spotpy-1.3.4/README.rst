..
    ...
    :paper: Houska, T, Kraft, P, Chamorro-Chavez, A and Breuer, L; `SPOTting Model Parameters Using a Ready-Made Python Package`_; PLoS ONE; 2015
...
.. image:: https://img.shields.io/travis/spotpy/spotpy.svg
        :target: https://travis-ci.org/spotpy/spotpy
