...
* in GUI mode select subtitles for which you want to use Property Files, then
  right click anywhere on file list and select "Use Subtitle Properties". You
  can select from recently used Property Files or you can open one from
  arbitrary location.
+
:img-file: spf-selection.png
