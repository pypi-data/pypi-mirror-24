...
class SubtitleProperties:
    ...
    def changeFormat(self):
        return self._changeFormat

    @changeFormat.setter
    def changeFormat(self, val):
        self._changeFormat = self._setBoolean(val)
    ...
    def _toJson(self):
        ...
        serializable["changeFormat"] = self._changeFormat
    ...
    def _fromJson(self, data):
        ...
        self._changeFormat = bool(data.get("changeFormat", True)) # pre 3.0 compatibility
...
class PropertiesFileApplier:
    ...
    def applyFor(self, filePath, data):
        ...
        # subtitle format
        if self._subProperties.changeFormat:
