...
from tubbs.plugins.core.message import AObj, StageI, AObjRule, IObj, IObjRule, FormatRange, FormatAt, FormatExpr


class TubbsNvimPlugin(Logging, NvimStatePlugin, name='tubbs', prefix='tub'):

    def __init__(self, vim: neovim.api.Nvim) -> None:
        super().__init__(NvimFacade(vim, 'tubbs'))
        self.tubbs: Tubbs = None
