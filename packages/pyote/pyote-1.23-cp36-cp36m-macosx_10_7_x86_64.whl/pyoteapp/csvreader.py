...
tangraNeedsBackroundSubtraction = True
...
def tangraParser(line, frame, time, value, ref1, ref2, ref3):
    ...
    frame.append(part[0])
    time.append(part[1])
    if tangraNeedsBackroundSubtraction:
...
def readAs(file):
    global tangraNeedsBackroundSubtraction
    ...
    if kind == 'Tangra':
        ...
        retval = msg.exec_()
        tangraNeedsBackroundSubtraction = (retval == QMessageBox.Yes)
    elif kind == 'R-OTE':
