    ...
    def __init__(self, mode):
        ...
        if self.mode == "redis":
            try:
                ...
                print("Can't able to connect Redis. %s" % e)
	
        elif self.mode == "sqlalchemy":
            try:
                cache = SqlalchemyCache()
            except BaseException as e:
                print("Can't able to connect SqlalchemyCache. %s" % e)

        else:
            try:
                cache = NativeCache()
            except BaseException as e:
                print("Can't able to connect NativeCache. %s" % e)
