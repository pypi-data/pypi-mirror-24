   ...
   .. graphviz::
      ...
      digraph InheritanceGraph {
          ...
          subgraph cluster_quantizationtools {
              ...
              "abjad.tools.quantizationtools.CollapsingGraceHandler.CollapsingGraceHandler" [color=3,
                  group=2,
                  label=CollapsingGraceHandler,
                  shape=box];
              "abjad.tools.quantizationtools.ConcatenatingGraceHandler.ConcatenatingGraceHandler" [color=3,
                  group=2,
                  label=ConcatenatingGraceHandler,
                  shape=box];
              "abjad.tools.quantizationtools.DiscardingGraceHandler.DiscardingGraceHandler" [color=3,
                  group=2,
