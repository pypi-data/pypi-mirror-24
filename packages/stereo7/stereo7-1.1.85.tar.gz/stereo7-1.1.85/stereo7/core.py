...
if __name__ == '__main__':
    # sys.argv.extend('inapps -r /work/td_core/projects/syndicate-2 --app_kind lite'.split(' '))
    # sys.argv.extend('gen-ios -r /work/td_core/projects/syndicate-2'.split(' '))
    sys.argv.extend('build -r /work/td_core/projects/syndicate-2 -p ios -c pre-release --app_kind pro --build_version 1'.split(' '))
    main()
