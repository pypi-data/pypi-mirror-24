...
android_cmd_build = 'gradle @{CONFIGURATION} -p @{ROOT}/proj.android'

ios_cmd_build = 'xcodebuild -project @{ROOT}/proj.ios/Syndicate.xcodeproj archive -archivePath Syndicate.xcarchive -scheme Syndicate'
