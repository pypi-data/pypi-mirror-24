...
from ws4ever import backend
from ws4ever.backend import notify_clients, refresh_backend_conf
...
class RedisWebSocketApplicationTests(MyLiveServerTestCase):
    def setUp(self):
        refresh_backend_conf()
    ...
    def test_publish_client_message(self):
        with patch('redis.client.PubSub.psubscribe',
            ...
            gevent.spawn(backend.subscribe_redis_message)
...
class MemoryWebSocketApplicationTests(MyLiveServerTestCase):
    def setUp(self):
        refresh_backend_conf()
