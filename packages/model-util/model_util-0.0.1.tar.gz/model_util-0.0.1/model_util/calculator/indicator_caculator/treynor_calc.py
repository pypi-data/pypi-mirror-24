...
class TreynorCalc(BaseCalculator):
    def _calc(self, nav_list, profit_list, risk_free_profit_list, index_nav_list,
              index_profit_list):
        return TreynorCalc.value_calc(profit_list, risk_free_profit_list, index_profit_list, self.frequency)

    @staticmethod
    def value_calc(profit_list, risk_free_profit_list, index_profit_list, frequency):
        ...
        return ((yearly_return_a - yearly_return_f) / beta_code_index).quantize(
