...
def startandmonitor(url,username,password,job, parameters, wait, token):
...
def startjob(url,username,password,job, parameters, token):
...
def queue(url,username,password):
