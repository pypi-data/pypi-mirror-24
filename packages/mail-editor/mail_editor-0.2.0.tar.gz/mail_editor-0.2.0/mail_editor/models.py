...
class MailTemplate(models.Model):
    ...
    def render_subject(self, context):
        return Template(self.subject).render(Context(autoescape=False))
    ...
    def render_body(self, context):
        ...
        body = template.render({'base_url': settings.BASE_URL, 'content': partial_body}, None)

        # Transform any styles into inline styles.
        body = Premailer(body, base_url=settings.BASE_URL).transform()
