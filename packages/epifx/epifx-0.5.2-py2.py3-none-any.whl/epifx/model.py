...
class SEIR(pypfilt.Model):
    ...
    def init(self, params, vec):
        ...
        :param vec: An uninitialised state vector of correct dimensions (see
            :py:func:`~state_size`).
        """
        # Ensure we have received only the state vector matrix.
        check.is_only_statevec(params, vec)
    ...
    def set_params(self, vec):
        ...
        # TODO: take params as an argument so we can check matrix dimensions?
    ...
    def update(self, params, step_date, dt, is_fs, prev, curr):
        ...
        # Ensure we have received only the state vector matrix.
        check.is_only_statevec(params, prev)
        check.is_only_statevec(params, curr)
