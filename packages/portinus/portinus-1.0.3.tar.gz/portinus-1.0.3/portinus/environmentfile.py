...
class EnvironmentFile(object):
    """The file to read in to set environment variables in the stack"""
    ...
    def ensure(self):
        """Create/update the environment file for the given Portinus service"""
        if self:
    ...
    def remove(self):
        """Remove the environment file for the given Portinus service"""
