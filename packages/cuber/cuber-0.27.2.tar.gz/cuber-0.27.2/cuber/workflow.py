...
class Workflow():
    ...
    def run(self, disable_inmemory_cache = False):
        return self.__run_graph('main', disable_inmemory_cache = disable_inmemory_cache)
    ...
    def __run_graph(self, graph_, disable_inmemory_cache):
        ...
        if isinstance(graph_, basestring): # this is graph name
            ...
            return self.__run_graph(self.get_graph(graph_), disable_inmemory_cache = disable_inmemory_cache)
        ...
        for dep in graph_.get('deps', {}):
            ...
            res = self.__run_graph(dep['graph'], disable_inmemory_cache = disable_inmemory_cache)
        ...
        res = cube_init.get(disable_inmemory_cache = disable_inmemory_cache)
        return res
