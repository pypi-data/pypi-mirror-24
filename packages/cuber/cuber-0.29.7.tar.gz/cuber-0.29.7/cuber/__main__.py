...
class Main():
    ...
    def run_graph(self, workflow_file, full_result, comment, main, disable_inmemory_cache, disable_file_cache):
        ...
        try:
            ...
            data = wf.run(main = main, disable_inmemory_cache = disable_inmemory_cache, disable_file_cache = disable_file_cache)
...
def run(workflow_file, full_result, comment, main, disable_inmemory_cache, disable_file_cache):
    """
