...
if (filter_combination_id !== null && filter_box_ids.length !== 0) {
  $.ajax({
    ...
    success: function(data) {
      ...
      dashboard = dashboardContainer(mergeState.dashboard, mergeState.datasources, state.user_id);
      // console.info(sliceCombination)
      dashboard.init();
    }
  });
} else {
  dashboard = dashboardContainer(state.dashboard, state.datasources, state.user_id);
  dashboard.init();
}
