    ...
    loaders: [
      ...
      /* for mapbox-gl/js/geo/transform */
      {
        ...
        include: [
          ...
          '/cache/superset18/node_modules/mapbox-gl/js',
        ],
        loader: 'babel-loader',
      },
      /* for require('*.css') */
      ...
      },
      {
        ...
        include: [
          APP_DIR + '/node_modules/mapbox-gl/js/render/painter/use_program.js',
          // '/cache/superset18/node_modules/mapbox-gl/js/render/painter/use_program.js',
        ],
