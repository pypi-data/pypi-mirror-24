...
class Ensemble():
    ...
    def _matched_bin_sets(self, bins, contigs, bin_quality, min_quality, min_comp, max_cont, no_bin_matching):
        ...
        for cur_bm, cur_bid, _domain, comp, cont, quality, N50, gs in bin_quality:
            ...
            if not no_bin_matching and (quality >= min_quality and comp >= min_comp and cont <= max_cont):
                for test_bm, test_bid, _domain, comp, cont, quality, N50, gs in bin_quality:
                    ...
                    per_bp_in_common = bp_in_common / total_bp1
    ...
    def _bases_in_common(self, seq_lens1, seq_lens2):
        ...
        bp_in_common = sum([seq_len
                            for seq_id, seq_len in seq_lens2.items()
    ...
    def run(self, 
        ...
        if greedy: 
            ...
            fout_matched.write('No. Matched Bins\tRefined Bin ID\tCompleteness (%)\tContamination (%)\tQuality (%)')
