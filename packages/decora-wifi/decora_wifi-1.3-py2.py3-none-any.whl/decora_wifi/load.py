...
class Load(BaseModel):
    def __init__(self, session):
        super(Load, self).__init__(session)
    ...
    def get_feed_item(self, feed_items, attribs=None):
        if attribs is None:
            attribs = {}
        api = "/Loads/{0}/feedItems/{1}".format(self._id, feed_items)
        self._session.call_api(api, attribs, 'get')

    def get_activity_trigger(self, activity_triggers, attribs=None):
        if attribs is None:
            attribs = {}
        api = "/Loads/{0}/activityTriggers/{1}".format(self._id, activity_triggers)
        self._session.call_api(api, attribs, 'get')
    ...
    def get_load_snapshot(self, load_snapshots, attribs=None):
        if attribs is None:
            attribs = {}
        api = "/Loads/{0}/loadSnapshots/{1}".format(self._id, load_snapshots)
        self._session.call_api(api, attribs, 'get')
