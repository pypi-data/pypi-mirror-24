...
def main():
    ...
    if len(sys.argv) != 2:
        ...
        sys.exit(0)
    if sys.argv[1] == "-f":
        print('ESM backup initiated. The ESM will be inaccessible during this')
        print('process and it may take a long time depending upon the volume of data in the database.')
        print(host, user, passwd, config)
