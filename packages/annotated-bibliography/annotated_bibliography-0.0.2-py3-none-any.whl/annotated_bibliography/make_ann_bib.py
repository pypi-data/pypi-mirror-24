...
from annotated_bibliography.helpers import dict_helper, TAParser
...
def make_html(bibtex=None, markdown=None, output=None):
    ...
    print(directory)
    t = jinja2.Template(open(os.path.join(directory, "template.html")).read())
...
if __name__ == "__main__":
    ...
    _bibtex, _markdown, _output = "./example/bibtex.bib",  "./example/markdown.md",  "./example/output.html"
    make_html(_bibtex, _markdown, _output)
