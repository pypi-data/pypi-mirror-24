...
SETUP_DESCRIPTION = 'example: passivetotal setup myusername@example.org abcdef1234...'
ACCOUNT_DESCRIPTION = 'example: passivetotal account --account'
SSL_DESCRIPTION = 'example: passivetotal ssl riskiq --keyword'
DNS_DESCRIPTION = 'example: passivetotal dns example.org riskiq.com'
TRACKERS_DESCRIPTION = 'example: passivetotal trackers riskiq FacebookId'
MONITOR_DESCRIPTION = 'example: passivetotal monitor'
HOST_DESCRIPTION = 'example: passivetotal host example.org --trackers -D parents'
WHOIS_DESCRIPTION = 'example: passivetotal whois example.org'
ENRICH_DESCRIPTION = 'example: passivetotal enrich example.org'
ACTION_DESCRIPTION = 'example: passivetotal actions classify evil.example.org -s malicious'
PROJECT_DESCRIPTION = 'example: passivetotal project find'
ARTIFACT_DESCRIPTION = 'example: passivetotal artifact find'
...
def _add_args(p):
    ...
    p.add_argument('--delim', '-d', help='use delimiter')
