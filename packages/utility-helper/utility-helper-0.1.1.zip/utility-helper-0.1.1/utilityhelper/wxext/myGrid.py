...
# from helper.common.wx import myGridTable
import helper.wxext.myGridTable
...
class myGrid(wx.grid.Grid):
    def __init__(self, parent, dataTable, dataTypes = [], rowLabels=None, colLabels=None):
        ...
        self.tableBase = helper.wxext.myGridTable.GenericTable(dataTable, dataTypes, rowLabels, colLabels)
