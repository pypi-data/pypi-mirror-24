...
from pydatagateway import hive
from pydatagateway.common import UniversalSet
...
try:
    ...
    from pydatagateway import sqlalchemy_backports as processors
try:
...
if StrictVersion(sqlalchemy.__version__) < StrictVersion('0.7.0'):
    from pydatagateway import sqlalchemy_backports
