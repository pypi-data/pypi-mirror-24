...
from pydatagateway import common
from pydatagateway.common import DBAPITypeObject
# Make all exceptions visible in this module per DB-API
from pydatagateway.exc import *  # noqa
import base64
import getpass
import logging
import requests
...
class Cursor(common.DBAPICursor):
    ...
    def __init__(self, host, port='9000', username=None, password=None, catalog='hive', cluster=None, schema='default',
                 poll_interval=1, source='pydatagateway', session_props=None, protocol='http'):
        """
