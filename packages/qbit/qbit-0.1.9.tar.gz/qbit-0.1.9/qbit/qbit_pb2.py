...
_FUJITSUSOLVER = _descriptor.Descriptor(
  name='FujitsuSolver',
  full_name='qbit.services.FujitsuSolver',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='noise_model', full_name='qbit.services.FujitsuSolver.noise_model', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_iterations', full_name='qbit.services.FujitsuSolver.num_iterations', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_runs', full_name='qbit.services.FujitsuSolver.num_runs', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='offset_increase_rate', full_name='qbit.services.FujitsuSolver.offset_increase_rate', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='temperature_decay', full_name='qbit.services.FujitsuSolver.temperature_decay', index=4,
      number=5, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='temperature_interval', full_name='qbit.services.FujitsuSolver.temperature_interval', index=5,
      number=6, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='temperature_mode', full_name='qbit.services.FujitsuSolver.temperature_mode', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='temperature_start', full_name='qbit.services.FujitsuSolver.temperature_start', index=7,
...
_QUBOSOLUTIONLIST_QUBOSOLUTION_CONFIGURATIONENTRY = _descriptor.Descriptor(
  name='ConfigurationEntry',
  full_name='qbit.services.QuboSolutionList.QuboSolution.ConfigurationEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='qbit.services.QuboSolutionList.QuboSolution.ConfigurationEntry.key', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='qbit.services.QuboSolutionList.QuboSolution.ConfigurationEntry.value', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUBOSOLUTIONLIST_QUBOSOLUTION = _descriptor.Descriptor(
  name='QuboSolution',
  full_name='qbit.services.QuboSolutionList.QuboSolution',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='energy', full_name='qbit.services.QuboSolutionList.QuboSolution.energy', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='frequency', full_name='qbit.services.QuboSolutionList.QuboSolution.frequency', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='configuration', full_name='qbit.services.QuboSolutionList.QuboSolution.configuration', index=2,
  ...
  nested_types=[_QUBOSOLUTIONLIST_QUBOSOLUTION_CONFIGURATIONENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_QUBOSOLUTIONLIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='timing', full_name='qbit.services.QuboSolutionList.timing', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='solutions', full_name='qbit.services.QuboSolutionList.solutions', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_QUBOSOLUTIONLIST_QUBOSOLUTION, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_COMPLETEOPERATIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='qbit.services.CompleteOperationRequest.name', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='output', full_name='qbit.services.CompleteOperationRequest.output', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ERROROPERATIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='qbit.services.ErrorOperationRequest.name', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BILLINGPROFILE = _descriptor.Descriptor(
  name='BillingProfile',
  full_name='qbit.services.BillingProfile',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='stripe_token', full_name='qbit.services.BillingProfile.stripe_token', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BILLINGPROFILERESPONSE = _descriptor.Descriptor(
  ...
  full_name='qbit.services.BillingProfileResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ok', full_name='qbit.services.BillingProfileResponse.ok', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='profiles', full_name='qbit.services.BillingProfileResponse.profiles', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLIENT = _descriptor.Descriptor(
  name='Client',
  full_name='qbit.services.Client',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='qbit.services.Client.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='client_id', full_name='qbit.services.Client.client_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='client_secret', full_name='qbit.services.Client.client_secret', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='created_at', full_name='qbit.services.Client.created_at', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLIENTRESPONSE = _descriptor.Descriptor(
  name='ClientResponse',
  full_name='qbit.services.ClientResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ok', full_name='qbit.services.ClientResponse.ok', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='clients', full_name='qbit.services.ClientResponse.clients', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUBOREQUEST.fields_by_name['fujitsu'].message_type = _FUJITSUSOLVER
...
_QUBOSOLUTIONLIST_QUBOSOLUTION_CONFIGURATIONENTRY.containing_type = _QUBOSOLUTIONLIST_QUBOSOLUTION
_QUBOSOLUTIONLIST_QUBOSOLUTION.fields_by_name['configuration'].message_type = _QUBOSOLUTIONLIST_QUBOSOLUTION_CONFIGURATIONENTRY
_QUBOSOLUTIONLIST_QUBOSOLUTION.containing_type = _QUBOSOLUTIONLIST
_QUBOSOLUTIONLIST.fields_by_name['solutions'].message_type = _QUBOSOLUTIONLIST_QUBOSOLUTION
...
_COMPLETEOPERATIONREQUEST.fields_by_name['output'].message_type = google_dot_protobuf_dot_any__pb2._ANY
_STATUS.fields_by_name['details'].message_type = google_dot_protobuf_dot_any__pb2._ANY
_BILLINGPROFILERESPONSE.fields_by_name['profiles'].message_type = _BILLINGPROFILE
_CLIENTRESPONSE.fields_by_name['clients'].message_type = _CLIENT
...
DESCRIPTOR.message_types_by_name['FujitsuSolver'] = _FUJITSUSOLVER
...
FujitsuSolver = _reflection.GeneratedProtocolMessageType('FujitsuSolver', (_message.Message,), dict(
  DESCRIPTOR = _FUJITSUSOLVER,
  __module__ = 'qbit_pb2'
  # @@protoc_insertion_point(class_scope:qbit.services.FujitsuSolver)
  ))
_sym_db.RegisterMessage(FujitsuSolver)
...
QuboSolutionList = _reflection.GeneratedProtocolMessageType('QuboSolutionList', (_message.Message,), dict(
  ...
  QuboSolution = _reflection.GeneratedProtocolMessageType('QuboSolution', (_message.Message,), dict(
    ...
    ConfigurationEntry = _reflection.GeneratedProtocolMessageType('ConfigurationEntry', (_message.Message,), dict(
      DESCRIPTOR = _QUBOSOLUTIONLIST_QUBOSOLUTION_CONFIGURATIONENTRY,
      __module__ = 'qbit_pb2'
      # @@protoc_insertion_point(class_scope:qbit.services.QuboSolutionList.QuboSolution.ConfigurationEntry)
      ))
    ,
    DESCRIPTOR = _QUBOSOLUTIONLIST_QUBOSOLUTION,
    __module__ = 'qbit_pb2'
    # @@protoc_insertion_point(class_scope:qbit.services.QuboSolutionList.QuboSolution)
    ))
  ,
...
_sym_db.RegisterMessage(QuboSolutionList.QuboSolution)
_sym_db.RegisterMessage(QuboSolutionList.QuboSolution.ConfigurationEntry)
...
BillingProfile = _reflection.GeneratedProtocolMessageType('BillingProfile', (_message.Message,), dict(
  ...
  __module__ = 'qbit_pb2'
  # @@protoc_insertion_point(class_scope:qbit.services.BillingProfile)
  ))
...
BillingProfileResponse = _reflection.GeneratedProtocolMessageType('BillingProfileResponse', (_message.Message,), dict(
  ...
  __module__ = 'qbit_pb2'
  # @@protoc_insertion_point(class_scope:qbit.services.BillingProfileResponse)
  ))
...
Client = _reflection.GeneratedProtocolMessageType('Client', (_message.Message,), dict(
  DESCRIPTOR = _CLIENT,
  __module__ = 'qbit_pb2'
  # @@protoc_insertion_point(class_scope:qbit.services.Client)
  ))
...
ClientResponse = _reflection.GeneratedProtocolMessageType('ClientResponse', (_message.Message,), dict(
  ...
  __module__ = 'qbit_pb2'
  # @@protoc_insertion_point(class_scope:qbit.services.ClientResponse)
  ))
_sym_db.RegisterMessage(ClientResponse)


_QUBOSOLUTIONLIST_QUBOSOLUTION_CONFIGURATIONENTRY.has_options = True
_QUBOSOLUTIONLIST_QUBOSOLUTION_CONFIGURATIONENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
try:
  ...
  class QbitStub(object):
    ...
    def __init__(self, channel):
      ...
      self.AddBillingProfile = channel.unary_unary(
          ...
          request_serializer=BillingProfile.SerializeToString,
          response_deserializer=BillingProfileResponse.FromString,
          )
      ...
      self.CreateClient = channel.unary_unary(
          ...
          response_deserializer=ClientResponse.FromString,
          )
  ...
  def add_QbitServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'AddBillingProfile': grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=BillingProfile.FromString,
            response_serializer=BillingProfileResponse.SerializeToString,
        ),
        ...
        'CreateClient': grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=ClientResponse.SerializeToString,
        ),
  ...
  class BetaQbitStub(object):
    ...
    def AddBillingProfile(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      raise NotImplementedError()
    AddBillingProfile.future = None
    def GetBillingProfile(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      raise NotImplementedError()
    GetBillingProfile.future = None
    def CreateClient(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      raise NotImplementedError()
    CreateClient.future = None
    def ListClients(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      raise NotImplementedError()
    ListClients.future = None
    def DeleteClient(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      raise NotImplementedError()
    DeleteClient.future = None
  ...
  def beta_create_Qbit_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('qbit.services.Qbit', 'AddBillingProfile'): BillingProfile.FromString,
      ...
      ('qbit.services.Qbit', 'CreateClient'): Client.FromString,
      ('qbit.services.Qbit', 'DeleteClient'): Client.FromString,
      ('qbit.services.Qbit', 'ErrorOperation'): ErrorOperationRequest.FromString,
      ('qbit.services.Qbit', 'GetBillingProfile'): google_dot_protobuf_dot_empty__pb2.Empty.FromString,
      ...
      ('qbit.services.Qbit', 'ListClients'): google_dot_protobuf_dot_empty__pb2.Empty.FromString,
    ...
    response_serializers = {
      ('qbit.services.Qbit', 'AddBillingProfile'): BillingProfileResponse.SerializeToString,
      ...
      ('qbit.services.Qbit', 'CreateClient'): ClientResponse.SerializeToString,
      ('qbit.services.Qbit', 'DeleteClient'): ClientResponse.SerializeToString,
      ('qbit.services.Qbit', 'ErrorOperation'): google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ('qbit.services.Qbit', 'GetBillingProfile'): BillingProfileResponse.SerializeToString,
      ('qbit.services.Qbit', 'GetOperation'): Operation.SerializeToString,
      ('qbit.services.Qbit', 'GetOperationToWorkOn'): Operation.SerializeToString,
      ('qbit.services.Qbit', 'Hobo2Qubo'): BinaryPolynomial.SerializeToString,
      ('qbit.services.Qbit', 'ListClients'): ClientResponse.SerializeToString,
    ...
    method_implementations = {
      ('qbit.services.Qbit', 'AddBillingProfile'): face_utilities.unary_unary_inline(servicer.AddBillingProfile),
      ...
      ('qbit.services.Qbit', 'CreateClient'): face_utilities.unary_unary_inline(servicer.CreateClient),
      ('qbit.services.Qbit', 'DeleteClient'): face_utilities.unary_unary_inline(servicer.DeleteClient),
      ('qbit.services.Qbit', 'ErrorOperation'): face_utilities.unary_unary_inline(servicer.ErrorOperation),
      ('qbit.services.Qbit', 'GetBillingProfile'): face_utilities.unary_unary_inline(servicer.GetBillingProfile),
      ...
      ('qbit.services.Qbit', 'ListClients'): face_utilities.unary_unary_inline(servicer.ListClients),
  ...
  def beta_create_Qbit_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('qbit.services.Qbit', 'AddBillingProfile'): BillingProfile.SerializeToString,
      ...
      ('qbit.services.Qbit', 'CreateClient'): Client.SerializeToString,
      ('qbit.services.Qbit', 'DeleteClient'): Client.SerializeToString,
      ('qbit.services.Qbit', 'ErrorOperation'): ErrorOperationRequest.SerializeToString,
      ('qbit.services.Qbit', 'GetBillingProfile'): google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ...
      ('qbit.services.Qbit', 'Hobo2Qubo'): BinaryPolynomial.SerializeToString,
      ('qbit.services.Qbit', 'ListClients'): google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
    ...
    response_deserializers = {
      ('qbit.services.Qbit', 'AddBillingProfile'): BillingProfileResponse.FromString,
      ...
      ('qbit.services.Qbit', 'CreateClient'): ClientResponse.FromString,
      ('qbit.services.Qbit', 'DeleteClient'): ClientResponse.FromString,
      ('qbit.services.Qbit', 'ErrorOperation'): google_dot_protobuf_dot_empty__pb2.Empty.FromString,
      ('qbit.services.Qbit', 'GetBillingProfile'): BillingProfileResponse.FromString,
      ('qbit.services.Qbit', 'GetOperation'): Operation.FromString,
      ('qbit.services.Qbit', 'GetOperationToWorkOn'): Operation.FromString,
      ('qbit.services.Qbit', 'Hobo2Qubo'): BinaryPolynomial.FromString,
      ('qbit.services.Qbit', 'ListClients'): ClientResponse.FromString,
      ('qbit.services.Qbit', 'ListOperations'): ListOperationsResponse.FromString,
      ('qbit.services.Qbit', 'SolveQubo'): QuboResponse.FromString,
    }
    cardinalities = {
      'AddBillingProfile': cardinality.Cardinality.UNARY_UNARY,
      ...
      'CreateClient': cardinality.Cardinality.UNARY_UNARY,
      'DeleteClient': cardinality.Cardinality.UNARY_UNARY,
      'ErrorOperation': cardinality.Cardinality.UNARY_UNARY,
      'GetBillingProfile': cardinality.Cardinality.UNARY_UNARY,
