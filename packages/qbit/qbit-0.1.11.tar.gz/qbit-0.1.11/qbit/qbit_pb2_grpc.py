...
class QbitServicer(object):
  ...
  def ListOperations(self, request, context):
    """rpc AddBillingProfile(BillingProfile) returns (BillingProfileResponse){
    ...
    rpc GetBillingProfile(google.protobuf.Empty) returns (BillingProfileResponse){
    option (google.api.http) = {
    get: "/users/billing"
    };
    }
    ...
    rpc ListClients(google.protobuf.Empty) returns (ClientResponse){
    option (google.api.http) = {
    get: "/clients"
    };
    }

    rpc DeleteClient(Client) returns (ClientResponse){
    option (google.api.http) = {
