...
def setAsyncWorkers( N_workers ):
    ...
    or writing with the functions .  Defaults to 1.  Most computer systems do not benefit from 
    multiple simultaneous IO operations unless they have parallel R/W 
    drives.
    """
    if N_workers <= 0:
