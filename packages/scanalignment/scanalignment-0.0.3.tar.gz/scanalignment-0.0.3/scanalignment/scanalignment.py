...
##                self.roi.setPos([0, self.linesel])
    ...
    def openFile(self):
        if self.fpath != '':
            ...
            self.fformat = ''
        print "openFile"
        self.fpath = str(QtGui.QFileDialog.getOpenFileName(self.winMain, 'Open File', '/home/carlos/Documents/Elettra/Scan_alignment_project',\
                                                           "Images (*.png *.jpg *.tiff *.tif *.ssv);;HDF files (*.h5 *.hdf5)"))
    ...
    def saveProject(self):
        if self.fformat == "ssv":
            savename = str(QtGui.QFileDialog.getSaveFileName(self.winMain, 'Open File', '/home/carlos/Documents/Elettra/Scan_alignment_project',\
                                                             "HDF files (*.h5 *.hdf5)"))
    ...
    def exportImage(self):
        ...
        exportname = QtGui.QFileDialog.getSaveFileNameAndFilter(self.winMain, 'Open File', '/home/carlos/Documents/Elettra/Scan_alignment_project',\
