...
def downVideoGUI():
    ...
    def split_8_video():
        ...
        print new_video_path
        os.rename(video_path, new_video_path)
        cmd_line = "ffmpeg -ss 00:00:00 -t 00:14:50 -i " + new_video_path + "  -strict -2 -vcodec copy -acodec copy -y " + "split01.mp4"
        os.system(cmd_line)
        cmd_line = "ffmpeg -ss 00:14:50  -i " + new_video_path + " -strict -2 -vcodec copy -acodec copy -t 00:14:50 -y " + "split02.mp4"
        os.system(cmd_line)
        cmd_line = "ffmpeg -ss 00:29:40  -i " + new_video_path + " -strict -2 -vcodec copy -acodec copy -t 00:14:50 -y " + "split03.mp4"
        os.system(cmd_line)
        cmd_line = "ffmpeg -ss 00:44:30  -i " + new_video_path + " -strict -2 -vcodec copy -acodec copy -t 00:14:50 -y " + "split04.mp4"
        os.system(cmd_line)
        cmd_line = "ffmpeg -ss 00:59:20  -i " + new_video_path + " -strict -2 -vcodec copy -acodec copy -t 00:14:50 -y " + "split05.mp4"
        os.system(cmd_line)
        cmd_line = "ffmpeg -ss 01:14:10  -i " + new_video_path + " -strict -2 -vcodec copy -acodec copy -t 00:14:50 -y " + "split06.mp4"
        os.system(cmd_line)
        cmd_line = "ffmpeg -ss 01:29:00  -i " + new_video_path + " -strict -2 -vcodec copy -acodec copy -y " + "split07.mp4"
        os.system(cmd_line)
        return 0
