...
## ------------------------------------------------------------------------------------------------------------------
## Code was generated at Tue Aug 01 11:32:39 IDT 2017
## vDirect version: 4.1.1
## Open issues:
...
class RestClient(object):
    ...
    :param ssl_verify_context: bool SSL context verification [True]
    """
    def __init__(self, vdirect_ip=None, vdirect_user=None, vdirect_password=None,wait=None,
        ...
        self.ssl_verify_context = self._handle_param(ssl_verify_context,'VDIRECT_SSL_VERIFY_CONTEXT',True,converter=self._str2bool)
    ...
    def _handle_param(self,value,env_variable_name,default_value,mandatory=False,converter=None):
        if value is not None:
            ...
            if not envp:
            	envp = os.environ.get(env_variable_name.lower())
            if not envp:
                if mandatory:
