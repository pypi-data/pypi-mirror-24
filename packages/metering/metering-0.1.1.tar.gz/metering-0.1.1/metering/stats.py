...
A module for determining sample sizes used in M&V plans.
...
From UMP-
Precision provides convenient shorthand for expressing the interval believed to contain the estimator (for example, if the estimate is 530 kWh, and the relative precision level is 10%, then the interval is 530 \pm  kWh). (FOOTNOTE 4) In reporting estimates from a sample, it is essential to provide both the precision and its corresponding confidence level (typically 90% for energy-efficiency evaluations).

From Montgomery-
The length of a confidence interval is a measure of the precision of estimation...2E is the length of
