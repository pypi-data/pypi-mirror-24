    ...
    def __work_thread(self):
        ...
        while not self._stop:
            ...
            try:
                ...
                logger.info("download task: %s, to local path: %s, success", task.key, localpath)
                ...
                logger.info("upload task: %s, from local path: %s, success", task.key, localpath)
                ...
                logger.info("remove task: %s, file local path: %s, success", task.key, localpath)
