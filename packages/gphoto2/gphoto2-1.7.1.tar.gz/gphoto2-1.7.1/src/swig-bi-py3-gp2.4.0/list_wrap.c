...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"gp_list_find_by_name", _wrap_gp_list_find_by_name, METH_VARARGS, (char *)"\n"
		...
		"\n"
		"No guarantees as to the speed of the search, or in what sequence the list is\n"
		"searched.  \n"
		"\n"
		""},
	 ...
	 { (char *)"gp_list_populate", _wrap_gp_list_populate, METH_VARARGS, (char *)"\n"
		...
		"    the format  \n"
		"* `count` :  \n"
		"    number of entries to be added to the list return a gphoto2 error code  \n"
		"\n"
...
SWIGINTERN PyMethodDef SwigPyBuiltin___CameraList_methods[] = {
  { "__len__", (PyCFunction) _wrap_CameraList___len__, METH_NOARGS, (char *) "__len__() -> int" },
  { "__getitem__", (PyCFunction) _wrap_CameraList___getitem__, METH_O, (char *) "__getitem__(int idx) -> PyObject *" },
  { "count", (PyCFunction) _wrap_CameraList_count, METH_NOARGS, (char *) "count() -> int" },
