...
alias conda2close="source ~/anaconda2/bin/deactivate"
alias jenkins="java -jar ~/mysoftware/jenkins/jenkins.war"
alias juliapro="~/juliapro/JuliaPro-0.5.1.1/julia"
alias juno="~/juliapro/JuliaPro-0.5.1.1/Juno"
