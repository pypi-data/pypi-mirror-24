...
def churn_percentage_matrix(Month, Year, No_of_Years, model):
    """
    ...
    Month: The number of the base month e.g. 4 for April
...
def customers_on_base(base_customers, Month, Year, No_of_years, percentage_matrix):
    """
