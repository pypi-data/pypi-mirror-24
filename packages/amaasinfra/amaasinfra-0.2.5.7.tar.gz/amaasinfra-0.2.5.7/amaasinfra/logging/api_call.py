...
class APICallLogger(object):
    ...
    def record_api_call(self, asset_manager_id, api_call_type, api_call_subtype, client_id, token_asset_manager_id, username, environment='dev'):
        """ Record the API call """
        asset_manager_id = str(asset_manager_id)  # In case it gets sent in as an integer
        token_asset_manager_id = str(token_asset_manager_id)
