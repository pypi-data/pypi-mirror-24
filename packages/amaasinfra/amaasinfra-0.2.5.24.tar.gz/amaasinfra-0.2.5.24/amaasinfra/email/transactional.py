...
class SimpleEmail(object):
    def __init__(self, subject, message, to, sender='noreply@argomi.com'):
        self._sender= sender
        self._to = to
    ...
    def get_email_template(self, template_name):
        try:
            return pkg_resources.resource_string('amaasinfra', '{}.html'.format(template_name))
