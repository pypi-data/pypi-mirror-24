...
'''
 @package   pNbody
 @file      generate_cylindrical_model_exponnential.py
 @brief     Generate an exponential profile (both direction)
 @copyright GPLv3
...
name        		= 'expd.dat'		# output snap file
stats_name  		= 'stats_expd.dmp'	# output stat file
...
# create the model
nb = ic.expd(int(n*nf),Hr=hR,Hz=hz,Rmax=rmax,Zmax=zmax,irand=1,name=name,ftype='gadget')
