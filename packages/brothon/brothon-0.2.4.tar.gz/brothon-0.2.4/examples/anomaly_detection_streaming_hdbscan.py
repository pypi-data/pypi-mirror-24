...
if __name__ == '__main__':
    ...
    if args.bro_log:
        ...
        reader = live_simulator.LiveSimulator(args.bro_log, eps=1) # 1 event per second
        ...
        for row in reader.readrows():
            ...
            if time.time() > timer:
                ...
                # Try the hdbscan clustering
                clusterer = hdbscan.HDBSCAN()
                bro_df['cluster'] = clusterer.fit_predict(bro_matrix)
                bro_df['outlier_score'] = clusterer.outlier_scores_
                out_df = bro_df[bro_df['outlier_score'] > .5]
                ...
                odd_df = bro_df[odd_clf.predict(bro_matrix) == -1].copy()
