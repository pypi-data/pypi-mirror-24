...
setup(
    name             = scinum.__name__,
    version          = scinum.__version__,
    author           = scinum.__author__,
    author_email     = scinum.__email__,
    description      = scinum.__doc__.strip(),
    license          = scinum.__license__,
    url              = scinum.__contact__,
    keywords         = keywords,
