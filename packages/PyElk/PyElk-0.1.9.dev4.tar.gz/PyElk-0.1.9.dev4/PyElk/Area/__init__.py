...
class Area(Node):
    ...
    def last_keypad(self):
        _LOGGER.error('getting last keypad : ' + str(self._last_keypad))
        return self._last_keypad

    @last_keypad.setter
    def last_keypad(self, value):
        _LOGGER.error('setting last keypad : ' + str(value))
        self._last_keypad = value
