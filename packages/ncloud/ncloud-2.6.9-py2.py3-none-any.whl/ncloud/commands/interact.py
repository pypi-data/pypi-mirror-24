...
class Start(Command):
    ...
    def parser(cls, subparser):
        ...
        interact.add_argument("-v", "--volume-id", type=int,
                              help="ID of volume to mount in notebook.")
        interact.add_argument("-e", "--environment",
                              help="Name of the deep learning environment to "
                                   ...
                                   "interact`. If not supplied, neon will be "
                                   "used.")
    ...
    @staticmethod
    def call(config, gpus=1, volume_id=None, framework_version=None,
