...
from pyexcelios.compat import deprecated
from pyexcelios.worksheet import Worksheet

from pyexcelios.utils.indexed_list import IndexedList
from pyexcelios.utils.datetime  import CALENDAR_WINDOWS_1900
from pyexcelios.utils.exceptions import ReadOnlyWorkbookException

from pyexcelios.writer.write_only import WriteOnlyWorksheet, save_dump
from pyexcelios.writer.excel import save_workbook

from pyexcelios.styles.styleable import StyleArray
from pyexcelios.styles.named_styles import NamedStyle

from pyexcelios.chartsheet import Chartsheet
...
class Workbook(object):
    ...
    def _setup_styles(self):
        """Bootstrap styles"""
        from pyexcelios.styles.alignment import Alignment
        from pyexcelios.styles.borders import DEFAULT_BORDER
        from pyexcelios.styles.fills import DEFAULT_EMPTY_FILL, DEFAULT_GRAY_FILL
        from pyexcelios.styles.fonts import DEFAULT_FONT
        from pyexcelios.styles.protection import Protection
        from pyexcelios.styles.colors import COLOR_INDEX
    ...
    def save(self, filename):
        ...
        .. warning::
            ...
            modify or save the file will raise an :class:`pyexcelios.shared.exc.WorkbookAlreadySaved` exception.
        """
        if self.read_only:
