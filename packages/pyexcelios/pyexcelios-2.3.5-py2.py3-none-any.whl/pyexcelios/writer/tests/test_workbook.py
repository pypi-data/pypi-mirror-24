...
# package
from pyexcelios import Workbook, load_workbook
from pyexcelios.workbook.names.named_range import NamedRange
from pyexcelios.xml.functions import Element, tostring, fromstring
from pyexcelios.xml.constants import XLTX, XLSX, XLSM, XLTM
from .. excel import (
    save_workbook,
...
def test_write_named_range():
    from pyexcelios.writer.workbook import _write_defined_names
    wb = Workbook()
    ws = wb.active
...
def test_read_workbook_code_name(datadir, tmpl, code_name):
    from pyexcelios.reader.workbook import read_workbook_code_name
    datadir.chdir()
