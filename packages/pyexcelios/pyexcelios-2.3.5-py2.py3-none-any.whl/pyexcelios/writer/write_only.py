...
from pyexcelios.compat import removed_method
...
from pyexcelios.utils.exceptions import WorkbookAlreadySaved
from pyexcelios.writer.excel import ExcelWriter
...
from pyexcelios.xml.functions import xmlfile, Element

ALL_TEMP_FILES = []


@atexit.register
def _pyexcelios_shutdown():
...
def create_temporary_file(suffix=''):
    fobj = NamedTemporaryFile(mode='w+', suffix=suffix,
                              prefix='pyexcelios.', delete=False)
    filename = fobj.name
...
class DumpCommentWriter(CommentWriter):
    ...
    def _extract_comments(self):
        from pyexcelios.comments.properties import Comment
