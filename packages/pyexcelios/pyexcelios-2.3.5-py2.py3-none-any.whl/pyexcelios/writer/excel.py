...
from pyexcelios.drawing.spreadsheet_drawing import SpreadsheetDrawing
from pyexcelios.xml.functions import tostring, fromstring, Element
from pyexcelios.packaging.manifest import write_content_types
from pyexcelios.writer.strings import write_string_table
...
from pyexcelios.workbook.properties import write_properties
from pyexcelios.writer.theme import write_theme
from pyexcelios.writer.styles import StyleWriter
from .relations import write_rels
from pyexcelios.writer.worksheet import write_worksheet
from pyexcelios.workbook.names.external import (
    write_external_link,
    write_external_book_rel
)

from pyexcelios.comments.writer import CommentWriter
...
class ExcelWriter(object):
    ...
    def _write_chartsheets(self, archive):
        from pyexcelios.packaging.relationship import Relationship, RelationshipList
        from pyexcelios.worksheet.drawing import Drawing
...
def save_workbook(workbook, filename, as_template=False):
    ...
    :type workbook: :class:`pyexcelios.workbook.Workbook`
