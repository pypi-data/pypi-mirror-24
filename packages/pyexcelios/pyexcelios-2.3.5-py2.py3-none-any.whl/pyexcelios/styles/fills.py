...
from pyexcelios.descriptors import Float, Set, Alias, NoneSet
from pyexcelios.descriptors.sequence import ValueSequence
from pyexcelios.compat import safe_string

from .colors import ColorDescriptor, Color
from .hashable import HashableObject

from pyexcelios.xml.functions import Element, localname, safe_iterator
