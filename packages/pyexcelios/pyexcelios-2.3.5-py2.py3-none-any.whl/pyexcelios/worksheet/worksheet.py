...
from pyexcelios.utils.exceptions import (
    SheetTitleException,
    InsufficientCoordinatesException,
    NamedRangeException
)
from pyexcelios.utils.units import (
    points_to_pixels,
    DEFAULT_COLUMN_WIDTH,
    DEFAULT_ROW_HEIGHT
)
from pyexcelios.formatting import ConditionalFormatting
from pyexcelios.workbook.names.named_range import NamedRange
from pyexcelios.workbook.child import _WorkbookChild
from pyexcelios.utils.bound_dictionary import BoundDictionary
...
class Worksheet(_WorkbookChild):
    ...
    use :func:`pyexcelios.workbook.Workbook.create_sheet` instead
    ...
    def auto_filter(self):
        """Return :class:`~pyexcelios.worksheet.AutoFilter` object.
    ...
    def cell(self, coordinate=None, row=None, column=None, value=None):
        ...
        :rtype: :class:pyexcelios.cell.Cell
    ...
    def get_named_range(self, range_string):
        ...
        :rtype: tuples of tuples of :class:`pyexcelios.cell.Cell`
        """
