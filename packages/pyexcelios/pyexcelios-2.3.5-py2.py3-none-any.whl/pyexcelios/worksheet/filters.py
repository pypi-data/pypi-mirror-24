...
class AutoFilter(object):
    ...
    Don't create auto filters by yourself. It is created by :class:`~pyexcelios.worksheet.Worksheet`.
    You can use via :attr:`~~pyexcelios.worksheet.Worksheet.auto_filter` attribute.
    """
