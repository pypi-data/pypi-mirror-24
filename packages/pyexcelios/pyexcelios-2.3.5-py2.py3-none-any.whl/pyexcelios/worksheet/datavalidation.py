...
from pyexcelios.descriptors import Bool, NoneSet, String
from pyexcelios.descriptors.nested import NestedText
from pyexcelios.compat import OrderedDict, safe_string, deprecated, unicode
from pyexcelios.utils import coordinate_from_string
from pyexcelios.worksheet import rows_from_range
...
class DataValidation(Serialisable):
    ...
    def add_cell(self, cell):
        """Adds a pyexcelios.cell to this validator"""
        self.add(cell)
