...
from pyexcelios.xml.functions import XMLGenerator
...
def lxml_writer(ws=None):
    from pyexcelios.writer.lxml_worksheet import write_rows
    if ws is None:
        ws = make_worksheet()
...
def styled_sheet():
    from pyexcelios import Workbook
    from pyexcelios.styles import Font, Style, PatternFill, Color, colors
    ...
    #wb.save(get_output_path('test_pyexcelios_style_std_pregen.xlsx'))
