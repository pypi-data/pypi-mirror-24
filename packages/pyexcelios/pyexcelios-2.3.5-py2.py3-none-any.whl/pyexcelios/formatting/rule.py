...
# copyright pyexcelios 2010-2015

from pyexcelios.compat import basestring
...
from pyexcelios.descriptors.excel import HexBinary, ExtensionList
from pyexcelios.styles.colors import Color, ColorDescriptor
