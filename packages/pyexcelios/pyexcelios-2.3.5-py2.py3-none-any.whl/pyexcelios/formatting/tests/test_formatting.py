...
from pyexcelios.compat import OrderedDict

# package imports
from pyexcelios.reader.excel import load_workbook
from pyexcelios.xml.functions import tostring
from pyexcelios.writer.worksheet import write_conditional_formatting
from pyexcelios.styles import Border, Side, PatternFill, Color, Font, fills, borders, colors
from pyexcelios.styles.differential import DifferentialStyle
from pyexcelios.formatting import ConditionalFormatting
from pyexcelios.formatting.rule import ColorScaleRule, CellIsRule, FormulaRule, Rule
