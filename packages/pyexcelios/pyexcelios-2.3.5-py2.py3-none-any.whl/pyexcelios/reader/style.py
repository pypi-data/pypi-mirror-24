...
# package imports
from pyexcelios.compat import OrderedDict, zip
from pyexcelios.utils.indexed_list import IndexedList
from pyexcelios.styles import (
    numbers,
    Font,
    Fill,
    PatternFill,
...
from pyexcelios.styles.colors import COLOR_INDEX, Color
from pyexcelios.styles.styleable import StyleArray
from pyexcelios.styles.named_styles import NamedStyle
from pyexcelios.xml.functions import fromstring, safe_iterator, localname
from pyexcelios.xml.constants import SHEET_MAIN_NS, ARC_STYLE
