...
from pyexcelios.styles.colors import Color, BLACK, WHITE
...
from pyexcelios.xml.functions import Element, SubElement, tostring
...
from pyexcelios.compat.strings import safe_string
