...
from pyexcelios.xml.functions import NS_REGEX, Element
from pyexcelios.xml.constants import CHART_NS, REL_NS, DRAWING_NS
...
from pyexcelios.chart.shapes import GraphicalProperties
