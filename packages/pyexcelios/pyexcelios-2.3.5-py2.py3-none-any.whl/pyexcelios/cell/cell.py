...
from pyexcelios.utils.datetime  import (
    to_excel,
    time_to_days,
    timedelta_to_days,
    from_excel
...
from pyexcelios.utils.units import points_to_pixels
from pyexcelios.utils import (
    get_column_letter,
    column_index_from_string,
)
from pyexcelios.styles import numbers, is_date_format
from pyexcelios.styles.styleable import StyleableObject
...
class Cell(StyleableObject):
    ...
    def comment(self):
        """ Returns the comment associated with this cell
            ...
            :rtype: :class:`pyexcelios.comments.Comment`
        """
