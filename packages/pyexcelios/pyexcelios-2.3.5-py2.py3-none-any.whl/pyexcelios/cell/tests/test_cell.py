...
from pyexcelios.cell.cell import ERROR_CODES
...
def test_illegal_characters(dummy_cell):
    from pyexcelios.utils.exceptions import IllegalCharacterError
    from pyexcelios.compat import range
...
def test_time_regex(value, expected):
    from pyexcelios.cell.cell import TIME_REGEX
...
def test_fill(DummyWorksheet, Cell):
    from pyexcelios.styles import PatternFill
...
def test_border(DummyWorksheet, Cell):
    from pyexcelios.styles import Border
    border = Border()
    ws = DummyWorksheet
...
def test_alignment(DummyWorksheet, Cell):
    from pyexcelios.styles import Alignment
...
def test_protection(DummyWorksheet, Cell):
    from pyexcelios.styles import Protection
