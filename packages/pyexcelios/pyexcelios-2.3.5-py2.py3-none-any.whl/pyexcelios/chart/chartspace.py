...
from pyexcelios.descriptors.excel import (
    Percentage,
    ExtensionList
    )
...
from pyexcelios.drawing.colors import ColorMapping
...
from pyexcelios.worksheet.page import PageMargins, PrintPageSetup
