#!/usr/bin/env python3
"""
This module contains GUI elements for the BNMImage package.
"""
...
class Aquami_Gui(tk.Frame):
    ...
    def about(self):
        ...
        if not exists:    
            ...
            self.tlAbout.iconbitmap('icon.ico')
            ...
            self.aText.insert(tk.END, ''.join((
                ...
                'Computational Materials Science, vol. xxx, pp. xx-xx, Sep. 2017\n',
    ...
    def hyperlink_click(self, event):
        url = r'https://www.doi.org/10.1016/j.commatsci.2017.08.012'
