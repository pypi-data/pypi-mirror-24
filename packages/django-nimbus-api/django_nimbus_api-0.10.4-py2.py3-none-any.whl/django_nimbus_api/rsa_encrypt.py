...
if __name__ == '__main__':
    ...
    pw = "1234567890"
    print "raw: {}".format(pw)
    en_pw = encryptor.encrypt(pw, public, passphrase=passphrase, cipher_type=2, base64_key=base64_key)
    print "encrypt: {}".format(en_pw)
    de_pw = encryptor.decrypt(en_pw, private, passphrase=passphrase, cipher_type=2, base64_key=base64_key)
