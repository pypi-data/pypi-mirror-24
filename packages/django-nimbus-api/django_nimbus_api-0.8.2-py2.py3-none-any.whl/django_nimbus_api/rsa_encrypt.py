...
if __name__ == '__main__':
    ...
    en_pw = encryptor.encrypt(pw, public, cipher_type=2)
    print "encrypt: {}".format(en_pw)
    de_pw = encryptor.decrypt(en_pw, private, cipher_type=2)
    print "decrypt: {}".format(de_pw)

    print "===" * 10
    signature = encryptor.sign(pw, private, signature_type=1)
    print "signature: {}".format(signature)
    is_verify = encryptor.verify(pw, signature, public, signature_type=1)
