...
class TokenSignAuthentication(BaseAuthentication):
    expiry_minutes = 5
    auth_params = [
        u"token", u"username", u"platform", u"deviceid", u"timestamp", u"sign",
    ]
    sign_params = [
        u"username", u"platform", u"deviceid", u"token", u"timestamp", u"version",
    ]
    sign_prefix = u"SDCP"
    sign_param = u"sign"
    timestamp_param = u"timestamp"
    ...
    def authenticate_sign(self, request, **kwargs):
        ...
        newsign = self.get_sign(request, **kwargs)
