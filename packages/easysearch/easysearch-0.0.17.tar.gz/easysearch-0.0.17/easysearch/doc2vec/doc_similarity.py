...
class LabeledLineSentence(object):
    ...
    def __iter__(self):
        for idx, doc in enumerate(self.doc_list):
            yield TaggedDocument(doc['ctr_content_nlp'], [doc['ctr_id']])
...
class DocumentSimilarity(object):
    ...
    def train(self):
        ...
        # Ver o problema, está passando em cada documento somente uma vez
        #documents = self.make_labeled_csv(filename)
        documents = LabeledLineSentence(client.query_docs(job_id=self.job_id, rows=total).docs)
    ...
    def save_documents_to_csv(self, solr_client, total_docs, step=500):
        ...
        with open(filename, 'w', encoding='utf-8') as csvfile:
            ...
            for i in range(0, total_docs, step):
                ...
                for doc in res.docs:
                    try:
                        writer.writerow([doc['ctr_id'], doc['ctr_content_nlp']])
