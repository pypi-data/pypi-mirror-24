...
text_fields.append('api_Conteúdo_tg')

doc_similarity = DocumentSimilarity(collection=collection, job_id=job_id, text_fields=text_fields, easysearch_address=host, easysearch_port='8080')
