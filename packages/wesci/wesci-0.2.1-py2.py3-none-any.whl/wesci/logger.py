...
class Logger(object):
    ...
    platform at https://app.we-sci.com.
...
#   TARGET_URL = 'https://httpbin.org/post'
    TARGET_URL = 'https://api.we-sci.com/v1/assays'
    # TARGET_URL = 'http://127.0.0.1:5000/api/v1/assays'
    ...
    def add_input_params(self, input_params):
        ...
        """
        self.input_params.update(Logger.__convert_arg_to_hash(
            input_params,
    ...
    def add_output_params(self, output_params):
        ...
        """
        self.output_params.update(Logger.__convert_arg_to_hash(
            output_params,
    ...
    def log(self):
        ...
        Both to https://app.we-sci.com and locally
        """
