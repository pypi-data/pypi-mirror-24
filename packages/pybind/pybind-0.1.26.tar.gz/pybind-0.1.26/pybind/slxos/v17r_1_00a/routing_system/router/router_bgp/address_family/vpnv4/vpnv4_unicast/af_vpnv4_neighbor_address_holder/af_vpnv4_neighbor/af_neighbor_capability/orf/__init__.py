...
class orf(PybindBase):
  ...
  def _get_prefixlist(self):
    """
    Getter method for prefixlist, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpnv4_neighbor_address_holder/af_vpnv4_neighbor/af_neighbor_capability/orf/prefixlist (container)
    """
    return self.__prefixlist
      
  def _set_prefixlist(self, v, load=False):
    """
    Setter method for prefixlist, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpnv4_neighbor_address_holder/af_vpnv4_neighbor/af_neighbor_capability/orf/prefixlist (container)
