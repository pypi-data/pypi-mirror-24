...
class orf(PybindBase):
  ...
  def _get_prefixlist(self):
    """
    Getter method for prefixlist, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/af_neighbor_capability/orf/prefixlist (container)
    """
    return self.__prefixlist
      
  def _set_prefixlist(self, v, load=False):
    """
    Setter method for prefixlist, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/af_neighbor_capability/orf/prefixlist (container)
