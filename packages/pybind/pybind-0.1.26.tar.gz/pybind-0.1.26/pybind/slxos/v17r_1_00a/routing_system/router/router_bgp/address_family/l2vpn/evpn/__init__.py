...
class evpn(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__client_to_client_reflection','__graceful_restart','__retain','__neighbor',)
  ...
  _pyangbind_elements = {'client_to_client_reflection': client_to_client_reflection, 'graceful_restart': graceful_restart, 'retain': retain, 'neighbor': neighbor, }
