...
class test_profile(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__test_profile_name','__type','__cos','__tx_interval','__meas_interval','__fwd_avg','__fwd_max','__bwd_avg','__bwd_max','__start','__stop','__packets','__timeout',)
  ...
  _pyangbind_elements = {'test_profile_name': test_profile_name, 'type': type, 'cos': cos, 'tx_interval': tx_interval, 'meas_interval': meas_interval, 'fwd_avg': fwd_avg, 'fwd_max': fwd_max, 'bwd_avg': bwd_avg, 'bwd_max': bwd_max, 'start': start, 'stop': stop, 'packets': packets, 'timeout': timeout, }
