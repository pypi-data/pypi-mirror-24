...
class pim_mcache_state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__tot_entry_count','__src_addr','__grp_addr','__incoming_if','__rp_addr','__uptime','__flag_bmp','__is_w_g','__spt','__rpt','__reg','__regsupp','__regprobe','__lsrc','__lrcv','__sp_mode','__ssm_mode','__need_rte','__rpf_info','__age_mask','__kat','__pim_oif',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__pim_oif = YANGDynClass(base=pim_oif.pim_oif, is_container='container', presence=False, yang_name="pim-oif", rest_name="pim-oif", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'pim-oif', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-pim-operational', defining_module='brocade-pim-operational', yang_type='container', is_config=False)
  ...
  def _get_pim_oif(self):
    """
    Getter method for pim_oif, mapped from YANG variable /pim_mcache_state/pim_oif (container)
  ...
  def _set_pim_oif(self, v, load=False):
    """
    Setter method for pim_oif, mapped from YANG variable /pim_mcache_state/pim_oif (container)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=pim_oif.pim_oif, is_container='container', presence=False, yang_name="pim-oif", rest_name="pim-oif", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'pim-oif', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-pim-operational', defining_module='brocade-pim-operational', yang_type='container', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """pim_oif must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=pim_oif.pim_oif, is_container='container', presence=False, yang_name="pim-oif", rest_name="pim-oif", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'pim-oif', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-pim-operational', defining_module='brocade-pim-operational', yang_type='container', is_config=False)""",
        })
  ...
  _pyangbind_elements = {'tot_entry_count': tot_entry_count, 'src_addr': src_addr, 'grp_addr': grp_addr, 'incoming_if': incoming_if, 'rp_addr': rp_addr, 'uptime': uptime, 'flag_bmp': flag_bmp, 'is_w_g': is_w_g, 'spt': spt, 'rpt': rpt, 'reg': reg, 'regsupp': regsupp, 'regprobe': regprobe, 'lsrc': lsrc, 'lrcv': lrcv, 'sp_mode': sp_mode, 'ssm_mode': ssm_mode, 'need_rte': need_rte, 'rpf_info': rpf_info, 'age_mask': age_mask, 'kat': kat, 'pim_oif': pim_oif, }
