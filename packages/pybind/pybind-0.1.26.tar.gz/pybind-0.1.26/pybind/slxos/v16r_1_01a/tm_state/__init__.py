...
class tm_state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__tmdevicestataggr','__non_empty_voq','__buf_pool_stats','__tmcpustatsslot','__tmcpustatsslotallgrp','__tm_top_discard_pkt_data','__tm_top_max_queue_depth_data','__tm_max_buff_util_data','__tmvoqstatistics',)
  ...
  _pyangbind_elements = {'tmdevicestataggr': tmdevicestataggr, 'non_empty_voq': non_empty_voq, 'buf_pool_stats': buf_pool_stats, 'tmcpustatsslot': tmcpustatsslot, 'tmcpustatsslotallgrp': tmcpustatsslotallgrp, 'tm_top_discard_pkt_data': tm_top_discard_pkt_data, 'tm_top_max_queue_depth_data': tm_top_max_queue_depth_data, 'tm_max_buff_util_data': tm_max_buff_util_data, 'tmvoqstatistics': tmvoqstatistics, }
