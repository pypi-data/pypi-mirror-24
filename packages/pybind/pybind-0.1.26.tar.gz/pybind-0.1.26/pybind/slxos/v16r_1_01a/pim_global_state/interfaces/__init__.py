...
class interfaces(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__pim_interface_data',)
  ...
  _pyangbind_elements = {'pim_interface_data': pim_interface_data, }
