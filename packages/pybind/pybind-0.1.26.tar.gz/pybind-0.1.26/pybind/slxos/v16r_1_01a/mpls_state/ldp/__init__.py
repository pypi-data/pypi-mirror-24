...
class ldp(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ldp_out','__interface','__ldp_neighbors','__ldp_session_summary','__tunnels','__statistics','__ldp_fec_statistics','__ldp_database','__targeted_peer','__path','__ldp_session','__ldp_fec_prefix','__ldp_fec_vc',)
  ...
  _pyangbind_elements = {'ldp_out': ldp_out, 'interface': interface, 'ldp_neighbors': ldp_neighbors, 'ldp_session_summary': ldp_session_summary, 'tunnels': tunnels, 'statistics': statistics, 'ldp_fec_statistics': ldp_fec_statistics, 'ldp_database': ldp_database, 'targeted_peer': targeted_peer, 'path': path, 'ldp_session': ldp_session, 'ldp_fec_prefix': ldp_fec_prefix, 'ldp_fec_vc': ldp_fec_vc, }
