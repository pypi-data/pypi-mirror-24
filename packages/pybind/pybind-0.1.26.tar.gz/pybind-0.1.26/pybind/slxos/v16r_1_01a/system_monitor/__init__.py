...
class system_monitor(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__fan','__power','__temp','__cid_card','__compact_flash','__MM','__LineCard','__SFM','__port',)
  ...
  _pyangbind_elements = {'fan': fan, 'power': power, 'temp': temp, 'cid_card': cid_card, 'compact_flash': compact_flash, 'MM': MM, 'LineCard': LineCard, 'SFM': SFM, 'port': port, }
