...
class member_vlan(PybindBase):
  ...
  from YANG module brocade-mct - based on the path /cluster/member/member-vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'cluster', u'member', u'member-vlan']
  ...
  def _get_add_(self):
    """
    Getter method for add_, mapped from YANG variable /cluster/member/member_vlan/add (ui32-vlan-range)
...
be added to MCT.
  ...
  def _set_add_(self, v, load=False):
    """
    Setter method for add_, mapped from YANG variable /cluster/member/member_vlan/add (ui32-vlan-range)
...
be added to MCT.
  ...
  def _get_remove_(self):
    """
    Getter method for remove_, mapped from YANG variable /cluster/member/member_vlan/remove (ui32-vlan-range)
...
to be removed.
  ...
  def _set_remove_(self, v, load=False):
    """
    Setter method for remove_, mapped from YANG variable /cluster/member/member_vlan/remove (ui32-vlan-range)
    If this variable is read-only (config: false) in the
