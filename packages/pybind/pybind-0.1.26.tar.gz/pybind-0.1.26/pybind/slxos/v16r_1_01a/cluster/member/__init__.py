...
class member(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__member_vlan',)
  ...
  def _get_member_vlan(self):
    """
    Getter method for member_vlan, mapped from YANG variable /cluster/member/member_vlan (container)
  ...
  def _set_member_vlan(self, v, load=False):
    """
    Setter method for member_vlan, mapped from YANG variable /cluster/member/member_vlan (container)
  ...
  _pyangbind_elements = {'member_vlan': member_vlan, }
