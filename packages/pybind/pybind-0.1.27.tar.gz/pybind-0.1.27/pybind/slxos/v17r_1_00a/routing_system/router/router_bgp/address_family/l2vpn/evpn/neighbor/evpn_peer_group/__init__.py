...
class evpn_peer_group(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__evpn_neighbor_peergroup_name','__activate','__encapsulation','__maximum_prefix','__route_reflector_client','__allowas_in','__next_hop_unchanged','__enable_peer_as_check','__route_map','__send_community',)
