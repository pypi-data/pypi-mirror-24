...
class vpnv6_unicast(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__rr_group','__export_vrf_leaked_routes','__af_vpnv6_neighbor_address_holder',)
  ...
  def _get_rr_group(self):
    """
    Getter method for rr_group, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/rr_group (uint32)
    """
    return self.__rr_group
      
  def _set_rr_group(self, v, load=False):
    """
    Setter method for rr_group, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/rr_group (uint32)
  ...
  _pyangbind_elements = {'rr_group': rr_group, 'export_vrf_leaked_routes': export_vrf_leaked_routes, 'af_vpnv6_neighbor_address_holder': af_vpnv6_neighbor_address_holder, }
