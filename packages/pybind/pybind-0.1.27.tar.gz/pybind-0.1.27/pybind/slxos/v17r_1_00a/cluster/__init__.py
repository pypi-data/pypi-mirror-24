...
class cluster(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__cluster_name','__cluster_id','__member','__peer_interface','__peer','__client_interfaces_shutdown','__client_isolation_strict','__designated_forwarder_hold_time','__deploy','__client','__client_pw',)
