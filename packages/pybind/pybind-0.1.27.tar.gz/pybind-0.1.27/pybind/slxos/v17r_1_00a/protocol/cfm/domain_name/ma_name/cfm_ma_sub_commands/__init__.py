...
class cfm_ma_sub_commands(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__maid_format = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'default': {'value': 0}, u'long': {'value': 1}},), default=unicode("default"), is_leaf=True, yang_name="maid-format", rest_name="maid-format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Set MA ID Format to include domain details', u'cli-full-no': None, u'callpoint': u'setDot1agMaIdFormat'}}, namespace='urn:brocade.com:mgmt:brocade-dot1ag', defining_module='brocade-dot1ag', yang_type='maid-format-type', is_config=True)
  ...
  def _set_maid_format(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'default': {'value': 0}, u'long': {'value': 1}},), default=unicode("default"), is_leaf=True, yang_name="maid-format", rest_name="maid-format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Set MA ID Format to include domain details', u'cli-full-no': None, u'callpoint': u'setDot1agMaIdFormat'}}, namespace='urn:brocade.com:mgmt:brocade-dot1ag', defining_module='brocade-dot1ag', yang_type='maid-format-type', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """maid_format must be of a type compatible with maid-format-type""",
          'defined-type': "brocade-dot1ag:maid-format-type",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'default': {'value': 0}, u'long': {'value': 1}},), default=unicode("default"), is_leaf=True, yang_name="maid-format", rest_name="maid-format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Set MA ID Format to include domain details', u'cli-full-no': None, u'callpoint': u'setDot1agMaIdFormat'}}, namespace='urn:brocade.com:mgmt:brocade-dot1ag', defining_module='brocade-dot1ag', yang_type='maid-format-type', is_config=True)""",
        })
