...
class map_(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__vlan_vni_mapping','__vlan_and_bd',)
  ...
  _pyangbind_elements = {'vlan_vni_mapping': vlan_vni_mapping, 'vlan_and_bd': vlan_and_bd, }
