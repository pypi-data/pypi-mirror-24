...
class TecUtilRPC(object):
 ...
 def AddOnAllowUnload(self,add_on_id,do_allow_unload):
  args=((ValueType.Address,c_uint64,getattr(add_on_id,'value',None)),
 ...
 def AddOnRegForeignLibLoader(self,foreign_lib_id,foreign_lib_loader,client_data):
  args=((ValueType.Text,None,foreign_lib_id),
        (ValueType.Address,c_uint64,getattr(foreign_lib_loader,'value',None)),
 ...
 def AddPreWriteLayoutCallback(self,write_layout_pre_write_callback,client_data):
  args=((ValueType.Address,c_uint64,getattr(write_layout_pre_write_callback,'value',None)),
        (ValueType.ArbParam,None,client_data),)
 ...
 def AnimateContourLevelsX(self,arg_list):
  args=((ValueType.Address,c_uint64,getattr(arg_list,'value',None)),)
 ...
 def ArgListAppendArbParamPtr(self,arg_list,name,value):
  args=((ValueType.Address,c_uint64,getattr(arg_list,'value',None)),
        (ValueType.Text,None,name),
        (ValueType.ArbParam,None,value.contents.value),)
 ...
 def ArgListAppendSet(self,arg_list,name,value):
  args=((ValueType.Address,c_uint64,getattr(arg_list,'value',None)),
        (ValueType.Text,None,name),
        (ValueType.Address,c_uint64,getattr(value,'value',None)),)
 ...
 def ArgListAppendStringList(self,arg_list,name,string_list):
  args=((ValueType.Address,c_uint64,getattr(arg_list,'value',None)),
        (ValueType.Text,None,name),
        (ValueType.Address,c_uint64,getattr(string_list,'value',None)),)
 ...
 def ArgListGetStringPtrByIndex(self,arg_list,index):
  args=((ValueType.Address,c_uint64,getattr(arg_list,'value',None)),
        (ValueType.Scalar,c_int32,index),)
  rep=self.sndrcv("ArgListGetStringPtrByIndex",*args).Reply()
  self.chk(rep)
 ...
 def AuxDataDeleteItemByIndex(self,aux_data_ref,index):
  args=((ValueType.Address,c_uint64,getattr(aux_data_ref,'value',None)),
        (ValueType.Scalar,c_int32,index),)
 ...
 def AverageCellCenterData(self,zone_set,var_set):
  args=((ValueType.Address,c_uint64,getattr(zone_set,'value',None)),
        (ValueType.Address,c_uint64,getattr(var_set,'value',None)),)
 ...
 def ConnectGetPrevSharedZone(self,zones_to_consider,zone):
  args=((ValueType.Address,c_uint64,getattr(zones_to_consider,'value',None)),
 ...
 def ConvAddPostReadCallback(self,converter_id_string,converter_post_read_callback):
  args=((ValueType.Text,None,converter_id_string),
        (ValueType.Address,c_uint64,getattr(converter_post_read_callback,'value',None)),)
 ...
 def CreateIsoZones(self):
  rep=self.sndrcv("CreateIsoZones").Reply()
  self.chk(rep)
  return (rep.Status() == Status.Success)
 def CreateMirrorZones(self,source_zones,mirror_var):
  args=((ValueType.Address,c_uint64,getattr(source_zones,'value',None)),
 ...
 def CreateSliceZones(self):
  rep=self.sndrcv("CreateSliceZones").Reply()
  self.chk(rep)
  return (rep.Status() == Status.Success)
 ...
 def CreateStreamZones(self,concatenate_streams):
  args=((ValueType.Scalar,c_bool,concatenate_streams),)
  rep=self.sndrcv("CreateStreamZones",*args).Reply()
  self.chk(rep)
  return (rep.Status() == Status.Success)
 ...
 def CurveRegisterExtCrvFit(self,curve_fit_name,get_line_plot_data_points_callback,get_probe_value_callback,get_curve_info_string_callback,get_curve_settings_callback,get_abbreviated_settings_string_callback):
  args=((ValueType.Text,None,curve_fit_name),
        (ValueType.Address,c_uint64,getattr(get_line_plot_data_points_callback,'value',None)),
        (ValueType.Address,c_uint64,getattr(get_probe_value_callback,'value',None)),
        (ValueType.Address,c_uint64,getattr(get_curve_info_string_callback,'value',None)),
        (ValueType.Address,c_uint64,getattr(get_curve_settings_callback,'value',None)),
        (ValueType.Address,c_uint64,getattr(get_abbreviated_settings_string_callback,'value',None)),)
 ...
 def CustomLabelsAppend(self,label_list):
  args=((ValueType.Address,c_uint64,getattr(label_list,'value',None)),)
 ...
 def DataAlter(self,equation,zone_set,i_min,i_max,i_skip,j_min,j_max,j_skip,k_min,k_max,k_skip,dest_data_type):
  args=((ValueType.Text,None,equation),
        (ValueType.Address,c_uint64,getattr(zone_set,'value',None)),
 ...
 def DataAxialDuplicate(self,data_set_id,zones,spatial_vars,num_vectors,u_vars,v_vars,w_vars,is3_d_rotation,rotation_in_degrees,offset_angle_in_degrees,num_duplicates,origin,normal,add_zones_to_existing_strands):
  args=((ValueType.Scalar,c_int64,data_set_id),
        (ValueType.Address,c_uint64,getattr(zones,'value',None)),
 ...
 def DataElemGetFace(self,elem_to_face_map,elem,face_offset):
  args=((ValueType.Address,c_uint64,getattr(elem_to_face_map,'value',None)),
 ...
 def DataFECellGetUniqueNodes(self,zone,face_offset,cell_index,unique_nodes_size,unique_nodes):
  args=((ValueType.Scalar,c_int32,zone),
        (ValueType.Scalar,c_int32,face_offset),
        (ValueType.Scalar,c_int64,cell_index),
        (ValueType.Array,c_int32,unique_nodes_size),
 ...
 def DataFaceMapAssignBConns(self,face_map,num_bndry_faces,num_bndry_conns__array,face_bndry_elems__array,face_bndry_elem_zones__array):
  args=((ValueType.Address,c_uint64,getattr(face_map,'value',None)),
 ...
 def DataFaceMapCustomLOD(self,zone,num_faces,num_face_nodes,num_face_bndry_faces,num_face_bndry_conns,load_callback,unload_callback,cleanup_callback,client_data):
  args=((ValueType.Scalar,c_int32,zone),
        ...
        (ValueType.Scalar,c_int64,num_face_bndry_faces),
        (ValueType.Scalar,c_int64,num_face_bndry_conns),
        (ValueType.Address,c_uint64,getattr(load_callback,'value',None)),
        (ValueType.Address,c_uint64,getattr(unload_callback,'value',None)),
        (ValueType.Address,c_uint64,getattr(cleanup_callback,'value',None)),
        (ValueType.ArbParam,None,client_data),)
 ...
 def DataFaceNbrAssignArrayByRef(self,face_neighbor,dest_offset,num_neighbors,neighbor_elems):
  args=((ValueType.Address,c_uint64,getattr(face_neighbor,'value',None)),
 ...
 def DataFaceNbrFaceIsObscured(self,face_neighbor,element,face,active_zones):
  args=((ValueType.Address,c_uint64,getattr(face_neighbor,'value',None)),
        (ValueType.Scalar,c_int64,element),
        (ValueType.Scalar,c_int32,face),
        (ValueType.Address,c_uint64,getattr(active_zones,'value',None)),)
 ...
 def DataNodeAlloc(self,zone):
  ...
  self.chk(rep)
  return (rep.Status() == Status.Success)
 def DataNodeArrayGetByRef(self,source_node_map,source_offset,source_count):
  args=((ValueType.Address,c_uint64,getattr(source_node_map,'value',None)),
  ...
  self.chk(rep)
  return rep.Args(0).Uint8Array()
 def DataNodeArraySetByRef(self,dest_node_map,dest_offset,dest_count,source_node_array):
  args=((ValueType.Address,c_uint64,getattr(dest_node_map,'value',None)),
        (ValueType.Scalar,c_int64,dest_offset),
 ...
 def DataNodeGetByRef(self,node_map_ptr,element,corner):
  args=((ValueType.Address,c_uint64,getattr(node_map_ptr,'value',None)),
        (ValueType.Scalar,c_int64,element),
 ...
 def DataNodeGetClientData(self,node_map):
  args=((ValueType.Address,c_uint64,getattr(node_map,'value',None)),)
 ...
 def DataNodeSetByRef(self,nm,element,corner,node):
  args=((ValueType.Address,c_uint64,getattr(nm,'value',None)),
        (ValueType.Scalar,c_int64,element),
        (ValueType.Scalar,c_int32,corner),
 ...
 def DataNodeToElemMapGetElem(self,node_to_elem_map,node,elem_offset):
  args=((ValueType.Address,c_uint64,getattr(node_to_elem_map,'value',None)),
        (ValueType.Scalar,c_int64,node),
 ...
 def DataSetMakeVarsAvailableByUniqueID(self,data_set_id,zones,vars_needed):
  args=((ValueType.Scalar,c_int64,data_set_id),
        (ValueType.Address,c_uint64,getattr(zones,'value',None)),
        (ValueType.Address,c_uint64,getattr(vars_needed,'value',None)),)
 ...
 def DataValueAlloc(self,zone,var):
  ...
  self.chk(rep)
  return (rep.Status() == Status.Success)
 def DataValueArrayGetByRef(self,source_field_data,source_offset,source_count):
  args=((ValueType.Address,c_uint64,getattr(source_field_data,'value',None)),
        (ValueType.Scalar,c_int64,source_offset),
        (ValueType.Scalar,c_int64,source_count),)
 ...
 def DataValueArraySetByRef(self,dest_field_data,dest_offset,dest_count,source_value_array):
  args=((ValueType.Address,c_uint64,getattr(dest_field_data,'value',None)),
        (ValueType.Scalar,c_int64,dest_offset),
        (ValueType.Scalar,c_int64,dest_count),
 ...
 def DataValueCustomLOD(self,zone,var,variable_load,variable_unload,variable_cleanup,get_value_function,set_value_function,client_data):
  args=((ValueType.Scalar,c_int32,zone),
        (ValueType.Scalar,c_int32,var),
        (ValueType.Address,c_uint64,getattr(variable_load,'value',None)),
        (ValueType.Address,c_uint64,getattr(variable_unload,'value',None)),
        (ValueType.Address,c_uint64,getattr(variable_cleanup,'value',None)),
        (ValueType.Address,c_uint64,getattr(get_value_function,'value',None)),
        (ValueType.Address,c_uint64,getattr(set_value_function,'value',None)),
        (ValueType.ArbParam,None,client_data),)
  rep=self.sndrcv("DataValueCustomLOD",*args).Reply()
  self.chk(rep)
  return (rep.Status() == Status.Success)
 def DataValueGetByRef(self,field_data,point_index):
  args=((ValueType.Address,c_uint64,getattr(field_data,'value',None)),
        (ValueType.Scalar,c_int64,point_index),)
 ...
 def DataValueGetReadableNativeRefByUniqueID(self,dataset_id,zone,var):
  ...
  self.chk(rep)
  return self.read_ptr(rep.Args(0))
 def DataValueGetReadableRawPtr(self,zone,var):
  args=((ValueType.Scalar,c_int32,zone),
        (ValueType.Scalar,c_int32,var),)
  rep=self.sndrcv("DataValueGetReadableRawPtr",*args).Reply()
  self.chk(rep)
  return FieldDataType(rep.Args(1).Int32Value())
 ...
 def DataValueGetWritableNativeRefByUniqueID(self,dataset_id,zone,var):
  ...
  self.chk(rep)
  return self.read_ptr(rep.Args(0))
 def DataValueGetWritableRawPtr(self,zone,var):
  args=((ValueType.Scalar,c_int32,zone),
        (ValueType.Scalar,c_int32,var),)
  rep=self.sndrcv("DataValueGetWritableRawPtr",*args).Reply()
  self.chk(rep)
  return FieldDataType(rep.Args(1).Int32Value())
 def DataValueGetZoneVarByRef(self,fd):
  args=((ValueType.Address,c_uint64,getattr(fd,'value',None)),)
 ...
 def DialogErrMsg(self,message):
  ...
  self.chk(rep)
 def DialogGetColor(self,allow_multi_color):
  args=((ValueType.Scalar,c_bool,allow_multi_color),)
  rep=self.sndrcv("DialogGetColor",*args).Reply()
  self.chk(rep)
  return (
   (rep.Status() == Status.Success),
   rep.Args(0).Int32Value())
 ...
 def DynamicLabelRegisterCallback(self,dynamic_label_name,dynamic_label_callback,client_data):
  args=((ValueType.Text,None,dynamic_label_name),
        (ValueType.Address,c_uint64,getattr(dynamic_label_callback,'value',None)),
        (ValueType.ArbParam,None,client_data),)
  rep=self.sndrcv("DynamicLabelRegisterCallback",*args).Reply()
  self.chk(rep)
 def ElemOrientGetOrientation(self,element_orientation,element):
  args=((ValueType.Address,c_uint64,getattr(element_orientation,'value',None)),
        (ValueType.Scalar,c_int64,element),)
 ...
 def EventAddPostDrawCallback(self,draw_event_callback,client_data):
  args=((ValueType.Address,c_uint64,getattr(draw_event_callback,'value',None)),
        (ValueType.ArbParam,None,client_data),)
 ...
 def ExtractInstallCallback(self,extract_destination,information_line_text):
  args=((ValueType.Address,c_uint64,getattr(extract_destination,'value',None)),
        (ValueType.Text,None,information_line_text),)
  rep=self.sndrcv("ExtractInstallCallback",*args).Reply()
  self.chk(rep)
  return (rep.Status() == Status.Success)
 def ExtractTimesFromFileNames(self,file_names,require_alpha_token_matching):
  args=((ValueType.Address,c_uint64,getattr(file_names,'value',None)),
        (ValueType.Scalar,c_bool,require_alpha_token_matching),)
  rep=self.sndrcv("ExtractTimesFromFileNames",*args).Reply()
  self.chk(rep)
  return (
   (rep.Status() == Status.Success),
   rep.Args(0).float64Array())
 ...
 def FieldMapSetActive(self,field_map_set,assign_modifier):
  args=((ValueType.Address,c_uint64,getattr(field_map_set,'value',None)),
 ...
 def FourierTransform(self,independent_var,window_function,dependent_vars,source_zones,include_conjugates,obey_source_zone_blanking):
  args=((ValueType.Scalar,c_int32,independent_var),
        ...
        (ValueType.Address,c_uint64,getattr(dependent_vars,'value',None)),
        (ValueType.Address,c_uint64,getattr(source_zones,'value',None)),
 ...
 def ImageBitmapDestroy(self):
  ...
  self.chk(rep)
 def ImageGetColorTable(self):
  rep=self.sndrcv("ImageGetColorTable").Reply()
  self.chk(rep)
  return (
   rep.Args(0).uint8Array(),
   rep.Args(1).uint8Array(),
   rep.Args(2).uint8Array())
 def ImageGetDimensions(self):
  ...
  return (
   ...
   rep.Args(0).Int32Value(),
   rep.Args(1).Int32Value())
 def ImageIndexedBitmapCreate(self,region):
  ...
  return (
   ...
   rep.Args(1).uint8Array(),
   rep.Args(2).uint8Array())
 def ImageIndexedGetScanLine(self,scan_line):
 ...
 def ImageRGBBitmapCreate(self,region):
  ...
  self.chk(rep)
  return (rep.Status() == Status.Success)
 def ImageRGBGetScanLine(self,scan_line):
  args=((ValueType.Scalar,c_int32,scan_line),)
 ...
 def ImportAddConverter(self,converter_callback,converter_name,f_name_extension):
  args=((ValueType.Address,c_uint64,getattr(converter_callback,'value',None)),
 ...
 def ImportAddLoader(self,loader_callback,data_set_loader_name,loader_selected_callback,instruction_override_callback):
  args=((ValueType.Address,c_uint64,getattr(loader_callback,'value',None)),
        (ValueType.Text,None,data_set_loader_name),
        (ValueType.Address,c_uint64,getattr(loader_selected_callback,'value',None)),
        (ValueType.Address,c_uint64,getattr(instruction_override_callback,'value',None)),)
 ...
 def ImportResetLoaderInstr(self,data_set_loader_name,instructions):
  args=((ValueType.Text,None,data_set_loader_name),
        (ValueType.Address,c_uint64,getattr(instructions,'value',None)),)
 ...
 def InterfaceWinAddPreMsgFn(self,pre_translate_message_proc):
  args=((ValueType.Address,c_uint64,getattr(pre_translate_message_proc,'value',None)),)
 ...
 def InverseDistInterpolation(self,source_zones,dest_zone,var_list,inv_dist_exponent,inv_dist_min_radius,interp_pt_selection,interp_n_points):
  args=((ValueType.Address,c_uint64,getattr(source_zones,'value',None)),
        (ValueType.Scalar,c_int32,dest_zone),
        (ValueType.Address,c_uint64,getattr(var_list,'value',None)),
 ...
 def LineMapDelete(self,maps_to_delete):
  args=((ValueType.Address,c_uint64,getattr(maps_to_delete,'value',None)),)
 ...
 def LineMapSetActive(self,line_map_set,assign_modifier):
  args=((ValueType.Address,c_uint64,getattr(line_map_set,'value',None)),
        (ValueType.Scalar,c_int32,AssignOp(assign_modifier).value),)
 ...
 def LineMapSetAssignment(self,attribute,line_map_set,d_value,i_value):
  args=((ValueType.Text,None,attribute),
        (ValueType.Address,c_uint64,getattr(line_map_set,'value',None)),
        (ValueType.Scalar,c_double,d_value),
        (ValueType.ArbParam,None,i_value),)
 ...
 def LineMapShiftToBottom(self,maps_to_shift):
  args=((ValueType.Address,c_uint64,getattr(maps_to_shift,'value',None)),)
 ...
 def LineSegProbe(self,line_seg_probe_result,starting_position,ending_positions,num_ending_positions,i_cell,j_cell,k_cell,cur_zone,zones_to_search,vars_to_return,line_seg_probe_callback,client_data):
  args=((ValueType.Address,c_uint64,getattr(line_seg_probe_result,'value',None)),
        ...
        (ValueType.Address,c_uint64,getattr(zones_to_search,'value',None)),
        (ValueType.Address,c_uint64,getattr(vars_to_return,'value',None)),
        (ValueType.Address,c_uint64,getattr(line_seg_probe_callback,'value',None)),
        (ValueType.ArbParam,None,client_data),)
 ...
 def LockFinish(self,add_on):
  args=((ValueType.Address,c_uint64,getattr(add_on,'value',None)),)
 ...
 def MacroAddCommandCallback(self,command_processor_id_string,macro_command_callback):
  args=((ValueType.Text,None,command_processor_id_string),
        (ValueType.Address,c_uint64,getattr(macro_command_callback,'value',None)),)
 ...
 def MainlineInvoke(self,job,job_data):
  args=((ValueType.Address,c_uint64,getattr(job,'value',None)),
 ...
 def MenuAddStatusLineHelp(self,menu_item,status_line_help):
  args=((ValueType.Address,c_uint64,getattr(menu_item,'value',None)),
 ...
 def MenuInsertSeparator(self,parent_menu,insert_pos):
  args=((ValueType.Address,c_uint64,getattr(parent_menu,'value',None)),
 ...
 def MenuInsertToggle(self,parent_menu,insert_pos,toggle_label,activate_callback,activate_client_data,get_toggle_state_callback,get_toggle_state_client_data):
  args=((ValueType.Address,c_uint64,getattr(parent_menu,'value',None)),
        ...
        (ValueType.Address,c_uint64,getattr(activate_callback,'value',None)),
        (ValueType.ArbParam,None,activate_client_data),
        (ValueType.Address,c_uint64,getattr(get_toggle_state_callback,'value',None)),
 ...
 def MenuRegisterSensitivityCallback(self,menu_item,get_sensitivity_callback,get_sensitivity_client_data):
  args=((ValueType.Address,c_uint64,getattr(menu_item,'value',None)),
        (ValueType.Address,c_uint64,getattr(get_sensitivity_callback,'value',None)),
 ...
 def OnIdleQueueAddCallback(self,callback,client_data):
  args=((ValueType.Address,c_uint64,getattr(callback,'value',None)),
        (ValueType.ArbParam,None,client_data),)
 ...
 def OpenLayout(self,f_name,alt_instructions,append):
  args=((ValueType.Text,None,f_name),
        (ValueType.Address,c_uint64,getattr(alt_instructions,'value',None)),
 ...
 def ProbeAtPosSequenceEnd(self):
  ...
  self.chk(rep)
 def ProbeAtPosition(self,x,y,z,i_cell,j_cell,k_cell,plane,cur_zone,start_with_local_cell,source_zones,search_volume,get_zone_only,get_nearest_point):
  args=((ValueType.Scalar,c_double,x),
        (ValueType.Scalar,c_double,y),
        (ValueType.Scalar,c_double,z),
        (ValueType.Array,c_int64,i_cell),
        (ValueType.Array,c_int64,j_cell),
        (ValueType.Array,c_int64,k_cell),
        (ValueType.Array,c_int32,IJKPlanes(plane).value),
        (ValueType.Array,c_int32,cur_zone),
 ...
 def ProbeInstallCallback(self,probe_destination,information_line_text):
  args=((ValueType.Address,c_uint64,getattr(probe_destination,'value',None)),
        (ValueType.Text,None,information_line_text),)
 ...
 def ProbePerform(self,probe_info,callback):
  args=((ValueType.Address,c_uint64,getattr(probe_info,'value',None)),
        (ValueType.Address,c_uint64,getattr(callback,'value',None)),)
 ...
 def QuitAddQueryCallback(self,quit_query_callback):
  args=((ValueType.Address,c_uint64,getattr(quit_query_callback,'value',None)),)
 ...
 def RawColorMap(self,num_raw_rgb_values,raw_r_values__array,raw_g_values__array,raw_b_values__array):
  ...
  self.chk(rep)
  return (rep.Status() == Status.Success)
 def ReadBinaryData(self,get_header_info_only,f_name,i_version,data_set_title,num_zones,num_vars,var_names,zone_names,num_pts_i,num_pts_j,num_pts_k,zone_type,user_rec,dataset_aux_data,raw_dataspace_allocated,node_map,v_data_base):
  args=((ValueType.Scalar,c_bool,get_header_info_only),
        (ValueType.Text,None,f_name),
        (ValueType.Array,c_int32,i_version),
        (ValueType.Address,c_uint64,data_set_title.contents.value),
        (ValueType.Array,c_int32,num_zones),
        (ValueType.Array,c_int32,num_vars),
        (ValueType.Address,c_uint64,var_names.contents.value),
        (ValueType.Address,c_uint64,zone_names.contents.value),
        (ValueType.Address,c_uint64,num_pts_i.contents.value),
        (ValueType.Address,c_uint64,num_pts_j.contents.value),
        (ValueType.Address,c_uint64,num_pts_k.contents.value),
        (ValueType.Address,c_uint64,zone_type.contents.value),
        (ValueType.Address,c_uint64,user_rec.contents.value),
        (ValueType.Address,c_uint64,dataset_aux_data.contents.value),
        (ValueType.Scalar,c_bool,raw_dataspace_allocated),)
  rep=self.sndrcv("ReadBinaryData",*args).Reply()
  self.chk(rep)
  return (rep.Status() == Status.Success)
 ...
 def ReadDataSet(self,read_data_option,reset_style,file_names_or_instructions,data_set_reader,initial_plot_type,include_text,include_geom,include_custom_labels,include_data,collapse_zones_and_vars,zones_to_read,var_load_mode,var_position_list,var_name_list,i_skip,j_skip,k_skip):
  args=((ValueType.Scalar,c_int32,ReadDataOption(read_data_option).value),
        (ValueType.Scalar,c_bool,reset_style),
        (ValueType.Address,c_uint64,getattr(file_names_or_instructions,'value',None)),
        ...
        (ValueType.Address,c_uint64,getattr(zones_to_read,'value',None)),
        (ValueType.Scalar,c_int32,VarLoadMode(var_load_mode).value),
        (ValueType.Address,c_uint64,getattr(var_position_list,'value',None)),
        (ValueType.Address,c_uint64,getattr(var_name_list,'value',None)),
        (ValueType.Scalar,c_int64,i_skip),
        (ValueType.Scalar,c_int64,j_skip),
        (ValueType.Scalar,c_int64,k_skip),)
 ...
 def ScriptExecRegisterCallback(self,file_ext,script_language,script_exec_callback,client_data):
  args=((ValueType.Text,None,file_ext),
        ...
        (ValueType.Address,c_uint64,getattr(script_exec_callback,'value',None)),
        (ValueType.ArbParam,None,client_data),)
 ...
 def SetAddMember(self,set,member,show_err):
  args=((ValueType.Address,c_uint64,getattr(set,'value',None)),
 ...
 def SetCopy(self,dst_set,src_set,show_err):
  args=((ValueType.Address,c_uint64,getattr(dst_set,'value',None)),
        (ValueType.Address,c_uint64,getattr(src_set,'value',None)),
        (ValueType.Scalar,c_bool,show_err),)
 ...
 def SetIsEqual(self,set1,set2):
  args=((ValueType.Address,c_uint64,getattr(set1,'value',None)),
        (ValueType.Address,c_uint64,getattr(set2,'value',None)),)
 ...
 def SortUInt32ItemArray(self,item_array,item_count,item_comparator,client_data):
  args=((ValueType.Array,c_uint32,item_array),
        ...
        (ValueType.Address,c_uint64,getattr(item_comparator,'value',None)),
        (ValueType.ArbParam,None,client_data),)
 ...
 def StateChangeAddCallback(self,state_change_callback):
  args=((ValueType.Address,c_uint64,getattr(state_change_callback,'value',None)),)
 ...
 def StringListAppend(self,target,source):
  args=((ValueType.Address,c_uint64,getattr(target,'value',None)),
        (ValueType.Address,c_uint64,getattr(source,'value',None)),)
  rep=self.sndrcv("StringListAppend",*args).Reply()
  self.chk(rep)
  return (rep.Status() == Status.Success)
 def StringListAppendString(self,string_list,string):
  args=((ValueType.Address,c_uint64,getattr(string_list,'value',None)),
 ...
 def StringListSort(self,string_list,comparator,client_data):
  args=((ValueType.Address,c_uint64,getattr(string_list,'value',None)),
        (ValueType.Address,c_uint64,getattr(comparator,'value',None)),
        (ValueType.ArbParam,None,client_data),)
 ...
 def ThreadBroadcastCondition(self,condition):
  args=((ValueType.Address,c_uint64,getattr(condition,'value',None)),)
 ...
 def ThreadCreateDetached(self,thread_function,thread_data):
  args=((ValueType.Address,c_uint64,getattr(thread_function,'value',None)),
 ...
 def ThreadMutexLock(self,mutex):
  args=((ValueType.Address,c_uint64,getattr(mutex,'value',None)),)
 ...
 def ThreadPoolAddJob(self,job,job_data,job_control):
  args=((ValueType.Address,c_uint64,getattr(job,'value',None)),
        (ValueType.ArbParam,None,job_data),
        (ValueType.Address,c_uint64,getattr(job_control,'value',None)),)
 ...
 def ThreadPoolWait(self,job_control):
  args=((ValueType.Address,c_uint64,getattr(job_control,'value',None)),)
 ...
 def ThreadTimedWaitForCondition(self,condition,mutex,wait_period_in_ms):
  args=((ValueType.Address,c_uint64,getattr(condition,'value',None)),
        (ValueType.Address,c_uint64,getattr(mutex,'value',None)),
 ...
 def Triangulate(self,source_zones,do_boundary,boundary_zones,include_boundary_pts,triangle_keep_factor):
  args=((ValueType.Address,c_uint64,getattr(source_zones,'value',None)),
        ...
        (ValueType.Address,c_uint64,getattr(boundary_zones,'value',None)),
 ...
 def ViewGetPlotType(self,view_state):
  args=((ValueType.Address,c_uint64,getattr(view_state,'value',None)),)
 ...
 def WriteDataSet(self,f_name,include_text,include_geom,include_custom_labels,include_data,zones_to_write,vars_to_write,write_binary,use_point_format,ascii_precision):
  args=((ValueType.Text,None,f_name),
        ...
        (ValueType.Scalar,c_bool,include_custom_labels),
        (ValueType.Scalar,c_bool,include_data),
        (ValueType.Address,c_uint64,getattr(zones_to_write,'value',None)),
        (ValueType.Address,c_uint64,getattr(vars_to_write,'value',None)),
