...
#Average Point Values Over Time
#------------------------------
#
#This example shows how to access the values of each point in the grid over time then average them to achieve an contour plot showing the average value across time. 
#
#Assumtions include there is a single zone per time step and that each point location does not change over time.
#
#.. figure:: /_static/images/avg_vortex.png
#    :width: 300px
#    :figwidth: 300px
#
#.. literalinclude:: ../../examples/23_average_over_time.py
