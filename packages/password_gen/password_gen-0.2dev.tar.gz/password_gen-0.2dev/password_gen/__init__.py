...
def populate_digit(dig_range):
    ...
    if dig_range[0] >= 0 and dig_range[1] <= 9:
        DIGITS[0] = int(dig_start)
        DIGITS[1] = int(dig_stop)
    else:
...
def populate_char(char_range):
    ...
    if char_range[0] >= 33 and char_range[1] <= 47:
        CHARACTERS[0] = int(char_start)
        CHARACTERS[1] = int(char_stop)
    else:
...
def password_style_1():
    # 1: a digit, a randomized-case word, a special character, another word, another special character, a third word, a third special character, one last word, second digit
    print('\n')
    print(' '.join([str(randomize_digit(DIGITS)), randomize_case(), randomize_character(CHARACTERS), randomize_case(), randomize_character(CHARACTERS), randomize_case(), randomize_character(CHARACTERS), randomize_case(), str(randomize_digit(DIGITS))]))

def password_style_2():
    # 2: a special character, a randomized-case word, a digit, another word, another digit, third word, third digit, last word, special character
    print('\n')
    print(' '.join([randomize_character(CHARACTERS), randomize_case(), str(randomize_digit(DIGITS)), randomize_case(), str(randomize_digit(DIGITS)), randomize_case(), str(randomize_digit(DIGITS)), randomize_case(), randomize_character(CHARACTERS)]))

def password_style_3():
    # 3: a randomized-case word, a digit, another word, another digit, third word, third digit, last word
    print('\n')
    print(' '.join([randomize_case(), str(randomize_digit(DIGITS)), randomize_case(), str(randomize_digit(DIGITS)), randomize_case(), str(randomize_digit(DIGITS)), randomize_case()]))

def password_style_4():
    # 4: a randomized-case word, a special character, another word, another special character, third word, third special character, last word
    print('\n')
    print(' '.join([randomize_case(), randomize_character(CHARACTERS), randomize_case(), randomize_character(CHARACTERS), randomize_case(), randomize_character(CHARACTERS), randomize_case()]))
