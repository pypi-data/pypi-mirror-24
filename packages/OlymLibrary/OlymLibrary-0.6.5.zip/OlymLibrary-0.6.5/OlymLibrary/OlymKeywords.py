...
class OlymKeywords(object):
    ...
    def file_download(self,dir1,dir2,url,location):
...
if __name__ == '__main__':
    ...
    url = 'http://sahitest.com/demo/saveAs.htm'
    location = '//a[text()="testsaveas.zip"]'
    test=OlymKeywords().file_download(dir1,dir2,url,location)
