...
import os
import json
from azure.ml.api.schema.schemaUtil import _generate_service_schema
...
def generate_schema(run_func, inputs=None, outputs=None, filepath=None):
    ...
    :param inputs: dict mapping str -> azure.ml.api.schema.sampleDefinition.SampleDefinition
    :param outputs: dict mapping str -> azure.ml.api.schema.sampleDefinition.SampleDefinition
    ...
    :raises ValueError if input/output are not dict or their values are not
        azure.ml.api.schema.sampleDefinition.SampleDefinition
