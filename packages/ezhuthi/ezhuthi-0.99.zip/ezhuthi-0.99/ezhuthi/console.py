...
#  Updated parts of code to GTK+3
...
class GTKInterpreterConsole(gtk.ScrolledWindow):
    ...
    def __init__(self, locals=None):
        ...
        self.text.add_events( gdk.EventType.KEY_PRESS )
        ...
        #setup colors
        self.style_banner = self.textbuffer.create_tag("banner")
        self.style_banner.set_property( "foreground", "saddle brown" )

        self.style_ps1 = self.textbuffer.create_tag("ps1")
        ...
        self.style_ps2 = self.textbuffer.create_tag("ps2")
        ...
        self.style_out = self.textbuffer.create_tag("stdout")
        self.style_out.set_property( "foreground", "midnight blue" )
        self.style_err = self.textbuffer.create_tag("stderr")
...
def main():
    ...
    w.add_events( gdk.EventType.KEY_PRESS )
