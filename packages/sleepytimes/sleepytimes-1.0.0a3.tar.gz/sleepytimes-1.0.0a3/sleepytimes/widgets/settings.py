...
class SpindleHelp(HelpDialog):
    ...
    def __init__(self, parent):
        ...
        s = ('<h3>Spindle detection methods</h3>'
             ...
             'times the mean signal amplitude of all <i>artifact-free</i> '
             'epochs, between <b>Minimum duration</b> [0.4] s '
             'and <b>Maximum duration</b> s [no maximum].</li>'
             ...
             'order Chebyshev filter.</li>'
             '<li>The amplitude of the rectified filtered signal is used as a '
             'new time series.</li>'
