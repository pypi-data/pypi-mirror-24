...
def split(df,field):
    ...
    """
       ...
       This splits a data frame into a list of subset data frames """
    
    unique_field_values = set(df[field])
...
def unsplit(df_dict):
    ...
    return functools.reduce(lambda x,y: x.append(y) , df_list).sort_index()
