...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initautogenerated_element_samplers(void); /*proto*/
PyMODINIT_FUNC initautogenerated_element_samplers(void)
#else
PyMODINIT_FUNC PyInit_autogenerated_element_samplers(void); /*proto*/
PyMODINIT_FUNC PyInit_autogenerated_element_samplers(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_autogenerated_element_samplers(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init yt.utilities.lib.autogenerated_element_samplers", 0, __pyx_lineno, __pyx_filename);
    }
