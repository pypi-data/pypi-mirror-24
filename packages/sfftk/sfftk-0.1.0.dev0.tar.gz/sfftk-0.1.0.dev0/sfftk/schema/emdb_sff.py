...
#
# Generated Mon Jul 31 16:22:29 2017 by generateDS.py version 2.22a.
#
...
class segmentation(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, schemaVersion='0.6.0a4', version=None, name=None, software=None, transformList=None, filePath=None, primaryDescriptor=None, boundingBox=None, externalReferences=None, segmentList=None, details=None):
