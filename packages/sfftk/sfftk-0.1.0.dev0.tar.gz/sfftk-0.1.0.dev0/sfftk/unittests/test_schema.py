...
class TestSFFSegmentation(unittest.TestCase):
    ...
    def test_read_sff(self):
        ...
        segmentation = schema.SFFSegmentation(sff_file, silence=True)
        ...
        self.assertEqual(segmentation.filePath, "/Users/pkorir/Data/segmentations/seg/emd_1014.seg")
    ...
    def test_read_hff(self):
        ...
        with h5py.File(hff_file) as f:
            segmentation = schema.SFFSegmentation.from_hff(f)
        # assertions
        self.assertEqual(segmentation.name, "Segger Segmentation")
        self.assertTrue(len(segmentation.version) > 0)
        self.assertEqual(segmentation.software.name, "segger")
    ...
    def test_read_json(self):
        ...
        segmentation = schema.SFFSegmentation.from_json(json_file)
        # assertions
        self.assertEqual(segmentation.name, "Segger Segmentation")
        self.assertTrue(len(segmentation.version) > 0)
        self.assertEqual(segmentation.software.name, "segger")
