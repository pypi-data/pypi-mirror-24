...
with collab.manager(suppress_exceptions_after_logging_them=False, redirect_stdout_to_log=True) as col:
    ...
    collab.request_to_display_message("generated next Fibonacci number: %d" % next_number).feedback_buttons(True)
    ...
    if identifier_of_last_input_object is None:
        collab.request_program_execution('fibonacci', output_object_identifier)
    else:
        collab.request_program_execution('fibonacci', identifier_of_last_input_object, output_object_identifier)
