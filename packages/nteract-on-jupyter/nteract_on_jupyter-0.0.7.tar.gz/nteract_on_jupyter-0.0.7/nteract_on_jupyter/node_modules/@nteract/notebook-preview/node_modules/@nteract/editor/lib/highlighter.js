...
function highlight(s, code) {
  var lang = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "python";
  ...
  function flush() {
    if (curStyle) s.write('<span class="' + curStyle.replace(/(^|\s+)/g, "$1cm-") + '">' + esc(accum) + "</span>");else s.write(esc(accum));
  }
