...
class Helper(object):
    ...
    def info_log(self, transaction_id, entity_id, profile_id, description):
        ...
        message = self.logger.info(transaction_id, entity_id, profile_id, description)
    ...
    def publish_update_bid_mail(self):
        #TODO
        pass
    ...
    def publish_auction_bid_mail(self, type_account, type_user, bid_number,
                                 ...
                                 email, name, company_name, auction_number, annual_yield):
        user_account = queue_objs.UserAccountObject(type_account=type_account, type_user=type_user)
        ...
        entity_object = queue_objs.EntityObject(email=email, first_name=name)
        company_object = queue_objs.CompanyObject(name=company_name)
        auction_object = queue_objs.AuctionObject(object_id=auction_number,
                                                  annual_yield=annual_yield)

        message = self.queue_connector.message_publisher_factory('auction-bid',
                                                                 account=user_account,
                                                                 offer=offer_object,
    ...
    def publish_investment_certificate_mail(self, type_account, type_user, email, first_name,
        ...
        message = self.queue_connector.message_publisher_factory('investment-certificate',
                                                                 account=user_account,
                                                                 entity=entity_object,
                                                                 company=company_object,
                                                                 link=link,
    ...
    def publish_end_auction_mail(self, type_account, type_user, email, first_name,
        ...
        message = self.queue_connector.message_publisher_factory('end-auction',
                                                                 account=user_account,
    ...
    def publish_transaction_received_mail(self):
        #TODO
        pass

    def publish_signup_mail(self, type_account, type_user, profile_object, entity_object, user_object):
        user_account_object = queue_objs.UserAccountObject(type_account=type_account, type_user=type_user)

        message = self.rabbit_client.message_publisher_factory('signup',
                                                               account=user_account_object,
