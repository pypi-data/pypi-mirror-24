...
class IMU_Base(metaclass=abc.ABCMeta):
    ...
    A concrete class must be instantiated, which implements the property "get_data".
    An example of an concrete class is "IMU_dicts", where the in-data are passed in
    a dictionary.
    ...
    def q_type(self):
        """q_type determines how the orientation is calculated.
            ...
            the orientation calculation is performed with "q_type".
