...
class KcpWrapper(_object):
    ...
    def getMtu(self):
        return _kcp.KcpWrapper_getMtu(self)

    def setWndSize(self, sndwnd, rcvwnd):
        return _kcp.KcpWrapper_setWndSize(self, sndwnd, rcvwnd)

    def getSndWndSize(self):
        return _kcp.KcpWrapper_getSndWndSize(self)

    def getRcvWndSize(self):
        return _kcp.KcpWrapper_getRcvWndSize(self)
