...
import signal
import imp
from kyroller import Engine
from kyroller import BackTestAccount, Position
from kyroller import Order
import argparse
...
def run():
    ...
    positions = list(map(parse_position, args.positions.split(',')))
