 ...
 */
  ...
  __pyx_t_5 = __Pyx_PyObject_AsWritableString(__pyx_v_ccap); if (unlikely((__pyx_t_5 == ((const char *)NULL)) && PyErr_Occurred())) __PYX_ERR(0, 40, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__7 = (PyObject*)__Pyx_PyCode_New(1, 0, 2, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__6, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_zmq_backend_cython_utils_pyx, __pyx_n_s_has, 29, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__7)) __PYX_ERR(0, 29, __pyx_L1_error)
