...
_STATUS = _descriptor.Descriptor(
  name='Status',
  full_name='devheronpy._proto.system.Status',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='devheronpy._proto.system.Status.status', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='devheronpy._proto.system.Status.message', index=1,
...
class Status(_message.Message):
  ...
  # @@protoc_insertion_point(class_scope:devheronpy._proto.system.Status)


DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), '\n\036com.twitter.devheronpy._proto.systemB\006Common')
