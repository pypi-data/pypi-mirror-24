...
from devheronpy.stream import Stream
from devheronpy.bolt.window_bolt import SlidingWindowBolt
from devheronpy.custom_grouping import ICustomGrouping
from devheronpy.component.component_spec import GlobalStreamId
from devheronpy.stream import Grouping

from devheronpy.streamlet import Streamlet, TimeWindow
from devheronpy.streamlet import OperationType
...
class ReduceByKeyAndWindowStreamlet(Streamlet):
  ...
  def _calculate_inputs(self):
    return {GlobalStreamId(self._parents[0]._stage_name, self._parents[0]._output) :
            Grouping.custom("devheronpy.streamlet.reducebykeyandwindowbolt.ReduceGrouping")}
