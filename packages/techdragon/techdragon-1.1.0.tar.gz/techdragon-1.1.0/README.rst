...
.. |commits-since| image:: https://img.shields.io/github/commits-since/techdragon/python-techdragon/v1.1.0.svg
    :alt: Commits since latest release
    :target: https://github.com/techdragon/python-techdragon/compare/v1.1.0...master
