...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 8), // int()(float *, float *, long long *, float *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 25), // float *
/*  2 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  3 */ _CFFI_OP(_CFFI_OP_POINTER, 26), // long long *
/*  4 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  5 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  6 */ _CFFI_OP(_CFFI_OP_FUNCTION, 8), // int()(int *, int)
/*  7 */ _CFFI_OP(_CFFI_OP_POINTER, 8), // int *
/*  8 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
/*  9 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 10 */ _CFFI_OP(_CFFI_OP_FUNCTION, 8), // int()(int, float *, float *, long long *, long long *, long long *, float *)
...
static const struct _cffi_global_s _cffi_globals[] = {
  ...
  { "PAPI_accum_counters", (void *)_cffi_f_PAPI_accum_counters, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 19), (void *)_cffi_d_PAPI_accum_counters },
  { "PAPI_epc", (void *)_cffi_f_PAPI_epc, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 10), (void *)_cffi_d_PAPI_epc },
  ...
  { "PAPI_num_components", (void *)_cffi_f_PAPI_num_components, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 23), (void *)_cffi_d_PAPI_num_components },
  { "PAPI_num_counters", (void *)_cffi_f_PAPI_num_counters, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 23), (void *)_cffi_d_PAPI_num_counters },
  { "PAPI_read_counters", (void *)_cffi_f_PAPI_read_counters, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 19), (void *)_cffi_d_PAPI_read_counters },
  { "PAPI_start_counters", (void *)_cffi_f_PAPI_start_counters, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 6), (void *)_cffi_d_PAPI_start_counters },
  { "PAPI_stop_counters", (void *)_cffi_f_PAPI_stop_counters, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 19), (void *)_cffi_d_PAPI_stop_counters },
};
