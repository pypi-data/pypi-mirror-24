...
##                self.roi.setPos([0, self.linesel])
    ...
    def openFile(self):
        if self.fpath != '':
            ...
            self.fformat = ''
        print "openFile"
        self.fpath = QtGui.QFileDialog.getOpenFileName(self.winMain, 'Open File', os.environ['HOME'],\
    ...
    def saveProject(self):
        if self.fformat == "ssv":
            savename = str(QtGui.QFileDialog.getSaveFileName(self.winMain, 'Save File', os.environ['HOME'],\
                                                             "HDF files (*.h5 *.hdf5)"))
    ...
    def exportImage(self):
        ...
        exportname = QtGui.QFileDialog.getSaveFileName(self.winMain, 'Export File', os.environ['HOME'],\
