...
from sanjeevheronpy import TopologyBuilder

from sanjeevheronpy.streamlet.operation import OperationType
...
class Streamlet(object):
  ...
  def map(self, map_function, stage_name=None, parallelism=None):
    ...
    """
    from sanjeevheronpy.streamlet.mapbolt import MapStreamlet
  ...
  def flatMap(self, flatmap_function, stage_name=None, parallelism=None):
    ...
    """
    from sanjeevheronpy.streamlet.flatmapbolt import FlatMapStreamlet
  ...
  def filter(self, filter_function, stage_name=None, parallelism=None):
    ...
    """
    from sanjeevheronpy.streamlet.filterbolt import FilterStreamlet
  ...
  def sample(self, sample_fraction, stage_name=None, parallelism=None):
    ...
    """
    from sanjeevheronpy.streamlet.samplebolt import SampleStreamlet
  ...
  def repartition(self, parallelism, stage_name=None):
    ...
    """
    from sanjeevheronpy.streamlet.repartitionbolt import RepartitionStreamlet
  ...
  def join(self, join_streamlet, time_window, stage_name=None, parallelism=None):
    ...
    """
    from sanjeevheronpy.streamlet.joinbolt import JoinStreamlet
  ...
  def reduceByWindow(self, time_window, reduce_function, stage_name=None):
    ...
    """
    from sanjeevheronpy.streamlet.reducebykeyandwindowbolt import ReduceByKeyAndWindowStreamlet
