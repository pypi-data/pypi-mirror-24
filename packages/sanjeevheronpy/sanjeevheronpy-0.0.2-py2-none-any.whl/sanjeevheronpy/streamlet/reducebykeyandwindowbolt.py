...
from sanjeevheronpy import SlidingWindowBolt, Stream
from sanjeevheronpy.custom_grouping import ICustomGrouping
from sanjeevheronpy.component import GlobalStreamId
from sanjeevheronpy.stream import Grouping

from sanjeevheronpy.streamlet import Streamlet, TimeWindow
from sanjeevheronpy.streamlet import OperationType
...
class ReduceByKeyAndWindowStreamlet(Streamlet):
  ...
  def _calculate_inputs(self):
    return {GlobalStreamId(self._parents[0]._stage_name, self._parents[0]._output) :
            Grouping.custom("sanjeevheronpy.streamlet.reducebykeyandwindowbolt.ReduceGrouping")}
