...
class PyCaffeCallback(BaseCallback, ModelHashInterface, GradCAMInterface, VisualBackPropInterface):
    ...
    def create_wrapped_solver(self, solver_class, prototext_path=None, solver_params=None):
        ...
        self._max_iterations = solver_params.get('maxIter')
        ...
        class WrappedSolver(solver_class):
            ...
            def solve(self):
                if callback._max_iterations is None:
                    callback.logger.error('maxIter not found in solver, this function will not be monitored')
                    raise MissingLinkException('maxIter is not found in model. Cannot use solve.')
