    ...
    def test_simple_encoding_found(self):
        ...
        with responses.RequestsMock(assert_all_requests_are_fired=False) as rsps:
            ...
            for url in URLS_HEADER.keys():
                ...
                _body = u'<html><head></head><body>%s</body></html>' % _body_char.decode("utf-8")
            ...
            for url in URLS_META.keys():
                ...
                _body = u'<html><head></head><body>%s</body></html>' % _body_char.decode("utf-8")
                if _header:
                    _body = u'<html><head><meta charset="%s"></head><body>%s</body></html>' % (_header, _body_char.decode("utf-8"))
                rsps.add(responses.GET,
                         url,
                         body=_body,
                         status=200,
            ...
            for url in to_test:
                ...
                self.assertEquals(r.encoding, _expected)
                self.assertEquals(r.text, _body)
