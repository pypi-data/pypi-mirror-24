...
`find_best_split(const rfr::data_containers::base< num_t, response_t, index_t >
    ...
    >>::iterator, 3 > &info_split_its, rng_t &rng) -> num_t`  
...
`best_split_categorical(typename std::vector< rfr::splits::data_info_t< num_t,
    ...
    rfr::util::weighted_running_statistics< num_t > right_stat, rng_t &rng) ->
    num_t`  
...
`find_best_split(const rfr::data_containers::base< num_t, response_t, index_t >
    ...
    index_t > >::iterator, k+1 > &info_split_its, rng_t &rng)=0 -> num_t`  
