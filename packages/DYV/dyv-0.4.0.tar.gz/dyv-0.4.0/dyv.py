...
def __execute_git_command(git_url, git_dest, git_branch, git_depth):
    git_dest = os.path.normpath(git_dest) + os.path.sep
...
def clone(ctx, repo, path, branch, all, depth):
    ...
    for br in branches:
        ...
        __execute_git_command(repo.get('path'), branch_path, br, depth)
