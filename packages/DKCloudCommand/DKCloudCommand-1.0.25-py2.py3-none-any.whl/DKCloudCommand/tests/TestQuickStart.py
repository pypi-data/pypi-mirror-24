...
class TestQuickStart(unittest.TestCase):
    ...
    def test_quick_start_1(self):
        ...
        self.assertTrue(order_run_completed)
        print '-> Pulling order run status: Done'

        print '\n----- Merge Parent to Child -----'

        print '-> Reverse merge: Dev_Sprint_1 to Feature_Sprint_1'
        ...
        print '-> Merge: Feature_Sprint_1 to Dev_Sprint_1'
    ...
    def dk_config_list(self, checks=None):
        ...
        checks.append('dk-cloud-file-location')
        checks.append('dk-cloud-username')
        checks.append('dk-cloud-merge-tool')
        checks.append('dk-cloud-port')
        checks.append('dk-cloud-ip')
        checks.append('dk-cloud-jwt')
        checks.append('dk-cloud-password')
