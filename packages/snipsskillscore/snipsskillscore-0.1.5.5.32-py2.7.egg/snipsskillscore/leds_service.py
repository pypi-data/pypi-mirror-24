...
try:
    ...
    log_error("Error starting microphone: insufficient permissions. Please reboot your device and try again.")
...
class LedsService:
    ...
    def start_animation(self, animation_id):
        ...
        self.thread_handler.run(target=self.animator.run, args=(identifier, animation, ))
