...
class Trainee(models.Model):
    ...
    status = models.PositiveSmallIntegerField(u"实习状态", null=True, blank=True, default=choices.STATUS_WEISHIXI,
    ...
    last_signin = models.ForeignKey("Signin", verbose_name=u"最近签到", null=True, blank=True)
    last_feedback = models.ForeignKey("Feedback", verbose_name=u"最近反馈", null=True, blank=True)
    last_institution = models.ForeignKey("Institution", verbose_name=u"最近工作单位", null=True, blank=True)
    current_institution = models.ForeignKey("Institution", verbose_name=u"当前工作单位", null=True, blank=True)
...
class Institution(models.Model):
    ...
    school = models.ForeignKey(School, verbose_name=School._meta.verbose_name, related_name="internship_institutions",
                              on_delete=models.PROTECT)
    student = models.ForeignKey(Student, verbose_name=Student._meta.verbose_name, related_name="institutions",
                                on_delete=models.PROTECT)
    ...
    organizing_institution_bar_code = models.CharField(u"组织机构代码", max_length=128, null=True, blank=True)
