...
from .widgetutils import CompositeChoicesWidget, JsonEditTextarea
import json
...
class CompositeChoicesField(Field):
    def __init__(self, choice_set={}, format_str=None, **kwargs):
        ...
        self.widget = CompositeChoicesWidget(choice_set=choice_set, format_str=format_str)
        kwargs.pop("max_length", None)
