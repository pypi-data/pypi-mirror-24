...
from util.datautils import list2csv
...
class StatResult(object):
    ...
    def as_csv(self, show_header=True, line_spliter=u"\n", field_spliter=u"\t"):
        ...
        return list2csv(self.data, line_spliter=line_spliter, field_spliter=field_spliter)
...
<td>%s</td>
        ...
        return tpl % (attrs,
                      ...
                      row_attrs,
                      list2csv(self.data, line_spliter=u"</td>\n</tr>\n<tr %s>\n<td>" % row_attrs,
                               field_spliter=u"</td>\n<td>")
                      )
...
class TimeStat(object):
    ...
    def get_times(self, date_range="今天"):
        from util.dateutils import get_next_date, format_the_date
