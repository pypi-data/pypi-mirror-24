...
class SendGrid(object):
    def __init__(self, api_user, api_key, url_base="https://api.sendgrid.com"):
        ...
        self.api_urls = {
            ...
            "unsubscribes": {
                ...
                "del": "/api/unsubscribes.delete.json"}
        }
    ...
    def call(self, api, resource, params=None):
        ...
        headers = {'Accept': '*/*'}
        response = requests.post(url, data=call_params, headers=headers)
        try:
    ...
    def del_unsubscribe(self, email):
        return self.call('unsubscribes', 'del', dict(email=email))
