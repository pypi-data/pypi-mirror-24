...
# -*- coding:utf-8 -*-
"""
      init = OpenATS.scripts.command:init
...
entry_points="""
      # -*- Entry points: -*-
      [console_scripts]
      ats-main = OpenATS.scripts.command:main
      ats-init = OpenATS.scripts.command:init
      ats-makeDataset = OpenATS.scripts.command:makeDataset
      ats-run = OpenATS.scripts.command:run
      ats-runAll = OpenATS.scripts.command:runAll
    """
# ============================================
...
version = next((line.split('=')[1].strip().replace("'", '')
                for line in open(os.path.join(here, APP_NAME, 'version.py'))
