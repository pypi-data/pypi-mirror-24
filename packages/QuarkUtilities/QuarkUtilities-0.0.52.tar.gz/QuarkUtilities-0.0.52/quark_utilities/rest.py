...
class GenericMembershipResource(GenericResource):
    ...
    async def create(self, handler, *args, **kwargs):
        ...
        subject = RequestContext.current_data()['subject']
        subject.ensure_has_permission_in_membership(self.resolve_permission('create'))
    ...
    async def update(self, handler, *args, **kwargs):
        ...
        subject.ensure_has_permission_in_membership(self.resolve_permission('update'))
    ...
    async def delete(self, handler, *args, **kwargs):
        resource_id = args[0]
        subject = RequestContext.get_param('subject')
        subject.ensure_has_permission_in_membership(self.resolve_permission('delete'))
    ...
    async def query(self, handler, *args, **kwargs):
        subject = RequestContext.get_param('subject')
        subject.ensure_has_permission_in_membership(self.resolve_permission('query'))
    ...
    async def get(self, handler, *args, **kwargs):
        resource_id = args[0]
        subject = RequestContext.get_param('subject')
        subject.ensure_has_permission_in_membership(self.resolve_permission('find'))
