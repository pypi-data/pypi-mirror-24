...
class TestChordCreations(unittest.TestCase):
    ...
    def test_normal_chord(self):
        ...
        self.assertEqual(c._quality._quality, "")
    ...
    def test_m75_chord(self):
        c = Chord("Bm7-5")
        self.assertEqual(c._root, "B")
        self.assertEqual(c._quality._quality, "m7-5")
    ...
    def test_slash_chord(self):
        ...
        self.assertEqual(c._quality._quality, "")
        self.assertEqual(c._on, "G")

    def test_minor_slash_chord(self):
        c = Chord("Dm/G")
        self.assertEqual(c._root, "D")
        self.assertEqual(c._quality._quality, "m")
        self.assertEqual(c._on, "G")
