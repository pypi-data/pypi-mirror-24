...
class OWExemplars(widget.OWWidget):
    name = "Exemplars"
    id = "orangecontrib.variants.widgets.exemplars"
    description = "Construct exemplars of data sets."
    icon = "icons/XXX.svg"
    priority = 50
    category = "Variants"
    keywords = ["exemplar", "cluster", "centroid", "medoid"]
